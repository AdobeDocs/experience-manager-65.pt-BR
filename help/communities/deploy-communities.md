...
Mais informações sobre a instalação de pacotes podem ser encontradas na página [Console da Web](/help/sites-deploying/web-console.md).
...
* Desmarque a caixa **Publicador primário**
* Selecione **Salvar**
