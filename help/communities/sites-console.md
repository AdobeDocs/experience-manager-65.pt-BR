...
* habilitar o serviço [de](/help/communities/deploy-communities.md#tunnel-service-on-author) túnel para gerenciar membros e grupos de membros
...
A prática recomendada, para garantir que o site esteja preparado para suportar muitos recursos, é tomar as seguintes etapas:

* instale o pacote de recursos [mais recente](/help/communities/deploy-communities.md#latestfeaturepack)
* habilitar o [Adobe Analytics](/help/communities/analytics.md) para o AEM Communities
...
* [habilitar o manipulador](/help/communities/social-login.md#adobe-granite-oauth-authentication-handler) OAuth para login social
...
Para criar um novo site da comunidade, selecione o **ícone Criar **ícone.
...
* **Título do sítio da Comunidade **: um título de exibição para o site.
...
* **Menu Modelo** de site da comunidade: use o menu suspenso para escolher um modelo [de site da](/help/communities/tools.md)comunidade disponível.
...
>
>Isso é feito habilitando o ` [AEM Communities Publish Tunnel Service](/help/communities/deploy-communities.md#tunnel-service-on-author)`para o ambiente do autor.
...
* **Permitir o registro**do usuário Se marcado, os visitantes do site podem se tornar membros da comunidade por meio do autoregistro.
...
* **Permitir acesso**anônimo Se marcada, o site da comunidade é *aberto *e qualquer visitante do site pode acessar o site.
Se não estiver marcada, somente os membros conectados poderão acessar o site.
Desmarque um *site privado *da comunidade. O padrão está marcado.

* **Permitir mensagens**Se marcada, os membros podem enviar mensagens entre si e para o grupo no site da comunidade.
Se desmarcada, as mensagens não são configuradas para a comunidade.
O padrão está desmarcado.

* **Permitir logons sociais: Facebook**Se marcada, permita que os visitantes do site façam logon com suas credenciais de conta do Facebook. A configuração [selecionada da nuvem do](/help/communities/social-login.md#create-a-facebook-connect-cloud-service) Facebook deve ser configurada para adicionar usuários ao grupo de membros do site da comunidade depois que o site da comunidade for criado.
...
* **Permitir logons sociais: Twitter** Se marcada, permita que os visitantes do site façam logon com suas credenciais de conta do Twitter. A configuração [selecionada da nuvem do](/help/communities/social-login.md#create-a-twitter-connect-cloud-service) Twitter deve ser configurada para adicionar usuários ao grupo de membros do site da comunidade depois que o site da comunidade for criado.
...
Além disso, a seleção de namespaces de tags para o site da comunidade limita a seleção apresentada ao definir catálogos e recursos. Consulte [Marcação de recursos](/help/communities/tag-resources.md) de ativação para obter informações importantes.
...
* **Gerentes da comunidade** Comecem a digitar para selecionar um ou mais membros da comunidade ou grupos de membros que podem gerenciar membros da comunidade e grupos de membros.

* **Moderadores** da comunidade Comecem a digitar para selecionar um ou mais membros da comunidade ou grupos de membros que devem ser confiáveis como moderadores de conteúdo gerado pelo usuário.

* **Membros** privilegiados da comunidade Comecem a digitar para selecionar um ou mais membros da comunidade ou grupos de membros que terão a capacidade de criar novo conteúdo quando `Allow Privileged Member` tiverem sido selecionados para uma função [da](/help/communities/functions.md)comunidade.

* **Administradores da comunidade** Comecem a digitar para selecionar um ou mais administradores de site que podem lidar com a estrutura do site independentemente de outros administradores de site e administradores padrão da comunidade. Eles podem criar grupos em qualquer nível da hierarquia e se tornar o administrador padrão dos grupos aninhados (mas podem ser removidos posteriormente da função de administrador dos grupos aninhados).
...
* **O conteúdo é pré-implantado** Se selecionado, o conteúdo da comunidade publicado não será exibido até ser aprovado por um moderador. O padrão está desmarcado. Para obter mais informações, consulte [Moderação do conteúdo](/help/communities/moderate-ugc.md#premoderation)da comunidade.

* **Limiar de sinalização antes que o conteúdo seja oculto** Se for maior que 0, o número de vezes que um tópico ou publicação deve ser sinalizado antes de ser ocultado da exibição pública. Se definido como -1, o tópico ou publicação sinalizado nunca será ocultado da exibição pública. O padrão é 5.

#### ANALYTICS {#analytics}

![chlimage_1-158](assets/chlimage_1-158.png)

* **Ative o Analytics** Only disponível quando o Adobe Analytics tiver sido [configurado](/help/communities/analytics.md) para recursos do Communities.
O padrão está desmarcado. Quando marcado, um menu de seleção adicional é exibido:

![chlimage_1-159](assets/chlimage_1-159.png)

* **Referência**da estrutura de configuração da nuvem No menu suspenso, selecione a estrutura de serviço da nuvem do Analytics configurada para este site da comunidade.
...
* **Permitir tradução** automática Quando marcada (o padrão está desmarcado), a tradução automática está ativada para UGC dentro do site. Isso não afeta nenhum outro conteúdo, como o conteúdo da página, mesmo se o site estiver configurado como um site multilíngue. Consulte [Traduzindo conteúdo](/help/communities/translate-ugc.md) gerado pelo usuário para obter informações sobre como configurar um serviço de tradução licenciado para o AEM Communities. Consulte [Traduzir conteúdo para sites](/help/sites-administering/translation.md) multilíngues para obter uma visão geral completa.

![chlimage_1-161](assets/chlimage_1-161.png)

* **Habilitar tradução automática para idiomas** selecionados Os idiomas habilitados para tradução automática padrão para a configuração do sistema especificada pela configuração [de integração de](/help/communities/translate-ugc.md#translation-integration-configuration)tradução. Essas configurações padrão podem ser substituídas para este site, excluindo padrões e/ou selecionando outros idiomas no menu suspenso.

* **Escolha o provedor** de tradução Por padrão, o provedor de serviços é um serviço de avaliação que usa apenas `microsoft`para demonstração. Se nenhum provedor de serviços de tradução estiver licenciado, a opção **Permitir tradução** automática deve ser desmarcada.

* **Escolha uma loja** compartilhada global Para um site com várias cópias de idioma, uma loja compartilhada global fornece um único thread de conversação, visível em cada cópia em idioma. Isso é feito selecionando um dos idiomas incluídos como uma cópia de idioma. O padrão é *Nenhuma loja* compartilhada global.

* **Escolha a configuração** do provedor de traduçãoEscolha uma estrutura [de integração de](/help/sites-administering/tc-tic.md) tradução criada para o provedor de tradução licenciado.

* **Selecione as opções de tradução para seu site da comunidade**

   * **Traduzir a página**inteira Se selecionada, todo o UGC em uma página é traduzido para o idioma base da página.
O padrão *não está selecionado*.

   * **Traduzir seleção somente**Se selecionada, uma opção de tradução será exibida ao lado de cada publicação, permitindo que postagens individuais sejam traduzidas para o idioma base da página.
...
O padrão *não está selecionado*.
   ...
   * **Não persistir nas traduções**Se selecionadas, as traduções não são armazenadas no repositório.
Se não for selecionado, as traduções serão mantidas.
O padrão *não está selecionado*.

* **Renderização inteligente** Selecione um dos
...
* **Marketing Cloud Org Id**(opcional) A ID de uma licença do [Video Heartbeat Analytics](/help/communities/analytics.md#video-heartbeat-analytics) .
...
* arrastar e soltar funções [adicionais da](/help/communities/functions.md) comunidade na estrutura do site
* em uma instância de uma função da comunidade na estrutura do site :

   * **`gear icon`**
editar configurações, incluindo o título de exibição e o nome do URL*bem como grupos de membros [privilegiados](/help/communities/users.md#privilegedmembersgroups)
...
* location `Adobe Granite Login Selector Authentication Handler`
* selecione o `pencil`ícone para abrir a configuração para edição
* insira um** Mapeamentos de página de login** como segue:
/content/sites/*&lt;nome-do-site>*/path/to/login/page**:**/content/sites/*&lt;nome-do-site>*por exemplo:
/content/sites/*contact*/en/sign:/content/sites/*contact*/en
...
* navegar até a página inicial do site da comunidade

   * por exemplo, [https://localhost:4503/content/sites/engage/en.html](https://localhost:4503/content/sites/engage/en.html)

* selecionar Desconectar
* selecione Login
* insira credenciais obviamente incorretas, como nome de usuário &quot;x&quot; e senha &quot;x&quot;
