...
* [revisa](/help/communities/reviews.md) : os membros postam um comentário ao classificar um item

A moderação do UGC é útil para reconhecer contribuições positivas e limitar as negativas (como spam e linguagem abusiva). O UGC pode ser moderado de vários ambientes: [](/help/communities/working-with-srp.md)

* [console](/help/communities/moderation.md)de moderação em massa O console de Moderação é acessível pelos administradores e moderadores [da](/help/communities/users.md) comunidade no ambiente público, bem como pelos administradores no ambiente do autor. Isso é possível quando o conteúdo da comunidade é armazenado em uma loja [](/help/communities/working-with-srp.md)comum.

* [moderação](/help/communities/in-context.md)em contexto A moderação no ambiente de publicação pode ser executada pelos administradores e moderadores da comunidade diretamente na página onde o conteúdo foi publicado.
...
* `Admin`
um usuário que é membro do grupo de administradores [da](/help/communities/users.md) comunidade

* `Moderator`
um membro de um grupo de moderadores [da](/help/communities/users.md#publishenvironmentusersandgroups) comunidade (tem permissões [de](/help/communities/in-context.md#moderatorpermissions)moderador)
...
Quando o UGC for pré-moderado, a publicação não aparecerá no site publicado até ser aprovada por uma ação de moderação. Durante a criação de um site [da](/help/communities/sites-console.md)comunidade, marcar a caixa `[Content is Premoderated](/help/communities/sites-console.md#moderation)` permitirá a pré-moderação de todo o site. Depois que os componentes são colocados em uma página, os componentes que suportam moderação podem ser configurados para pré-moderação usando uma configuração em sua caixa de diálogo de edição:

* [comentários](/help/communities/comments.md) e [revisões](/help/communities/reviews.md)na guia Moderação **** do usuário, marque **Pré-moderação**
* [fórum](/help/communities/forum.md), [ideação](/help/communities/ideation-feature.md), [QnA](/help/communities/working-with-qna.md)e [calendário](/help/communities/calendar.md)na guia **Configurações** , marque **Moderado**
...
1. Abra o console [da](https://localhost:4502/system/console/configMgr)Web, acessando /system/console/configMgr.
...
* Artigo 4º : defina o valor como 8 se houver mais palavras positivas do que palavras negativas
...
No console [de moderação em](/help/communities/moderation.md)massa, é possível filtrar e exibir o UGC com base no fato do sentimento ser negativo, neutro ou positivo.
...
* location `sentimentprocess.name`
