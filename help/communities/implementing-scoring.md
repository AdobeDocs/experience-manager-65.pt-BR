...
* [atribuição básica de cartões](#enable-scoring) aos membros para incentivar a sua participação (quantidade de conteúdo criado)
...
* regras de pontuação e marcação devem ser [aplicadas](#applytopage) à página (ou ancestral) na qual o componente é colocado
...
A pontuação não está ativada por padrão. As etapas básicas para a criação e habilitação da pontuação e da atribuição dos emblemas são:
...
* [ativar a identificação para recursos da comunidade](#enable-badges-for-component)
...
* se ambas as regras contiverem sub-regras aplicáveis ao mesmo `topic/verb` :
...
O nome da subregra normalmente segue o padrão de uso de um *sujeito, objeto *e *verbo.* Por exemplo:
...
* `1|/etc/community/badging/images/bronze-badge/jcr:content/bronze.png`
   ...
   * um crachá de bronze é avisado para ganhar 1 ponto
...
*membro-profile-url* = o ponto final para o perfil do membro em publisher, por exemplo: https://&lt;servidor>:&lt;porta>/home/users/community/riley/profile.social.json

>[!NOTE]
>
>O *membro-profile-url*
>
>* pode fazer referência a uma instância do autor se o Serviço [de](/help/communities/users.md#tunnel-service) Túnel estiver ativado
...
>[!NOTE]
>
>Uma nova propriedade booleana `allowBadges`, ativa/desativa a exibição de emblemas para uma instância do componente. Ele será configurável em caixas de diálogo [de edição de](/help/communities/author-communities.md) componentes atualizadas por meio de uma caixa de seleção denominada **Exibir emblemas**.
...
**[Componente](/help/communities/blog-feature.md)**de diárioSocialEvent`topic`= com/adobe/cq/social/diário
...
Em seguida, verifique se os componentes do fórum e dos comentários permitem a exibição de símbolos:

* novamente usando o CRXDE Lite
* navegar até o componente do fórum
