...
* [A atribuição avançada de ](/help/communities/advanced.md) badgesto identifica membros como especialistas (qualidade do conteúdo criado).
...
O console Comunidades [Distinções](/help/communities/badges.md) oferece a capacidade de adicionar símbolos personalizados que podem ser exibidos para um membro quando recebidos (concedidos) ou quando assumem uma função específica na comunidade (atribuídos).
...
* A marcação deve estar [ativada](#enableforcomponent) para o componente de recurso.
...
* **bronze**
   ...
   ![crachás concedidos](assets/awarded-badges.png)
...
Os símbolos personalizados podem ser instalados usando o console [Distintos](/help/communities/badges.md) e atribuídos ou especificados nas regras de identificação.
...
* Para pontos acumulados por regras de pontuação, atribua [emblemas](#badges) ([regras de identificação](#badging-rules)).
...
As regras de pontuação e sombreamento estão em vigor somente para instâncias de componentes que habilitaram a identificação ao editar a configuração do componente no [modo de criação](/help/communities/author-communities.md).

Uma propriedade booleana, `allowBadges`, ativa/desativa a exibição de emblemas para uma instância do componente. Ele é configurável na caixa de diálogo [edição de componente](/help/communities/author-communities.md) para o fórum, QnA e componentes de comentário por meio de uma caixa de seleção chamada **Distinções de exibição**.
   ...
   <td>
    <ul>
     ...
     <li>se "avançado", especifica o mecanismo de pontuação com base na qualidade e quantidade
      <ul>
       <li>requer um <a href="/help/communities/advanced.md">pacote adicional</a></li>
      </ul> </li>
...
Na versão estão incluídas duas regras de pontuação para [Função do fórum](/help/communities/functions.md#forum-function) (uma para os componentes Fórum e Comentários do recurso Fórum):
...
<table>
 <tbody>
  ...
  <tr>
   <td>badgingType</td>
   <td>Sequência de caracteres</td>
   <td><em>(opcional)</em> Identifica o mecanismo de pontuação como "básico" ou "avançado". Se o mecanismo avançado de pontuação for desejado, consulte <a href="/help/communities/advanced.md">Pontuação avançada e emblemas</a>. O padrão é "básico".</td>
  </tr>
  <tr>
...
Os símbolos podem ser atribuídos a membros usando o console [membros](/help/communities/members.md#badges-tab) ou programaticamente usando comandos cURL.
...
>O *perfil-membro-url*:
>
>* Pode consultar uma instância do autor se [Serviço de Túnel](/help/communities/users.md#tunnel-service) estiver ativado.
>* Pode ser um nome obscuro e aleatório - consulte [Lista de verificação de segurança](/help/sites-administering/security-checklist.md#verify-that-you-are-not-disclosing-personally-identifiable-information-in-the-users-home-path) em relação à ID autorizada.
...
>[!NOTE]
>
>Uma nova propriedade booleana, `allowBadges`, ativa/desativa a exibição de emblemas para uma instância do componente. Ele será configurável em [caixas de diálogo de edição de componente](/help/communities/author-communities.md) atualizadas por meio de uma caixa de seleção chamada **Distinções de exibição**.
...
É possível tentar marcar e marcar rapidamente usando o [Site de Introdução](/help/communities/getting-started.md) (engajar):
...
![marcação de teste](assets/test-scoring-badging.png)
...
Para obter informações sobre o mecanismo de pontuação avançado, consulte [Pontuação Avançada e Crachás](/help/communities/advanced.md).

O Quadro de líderes [componente](/help/communities/enabling-leaderboard.md) e [função](/help/communities/functions.md#leaderboard-function) configuráveis simplificam a exibição de membros e suas pontuações em um site da comunidade.
