...
+ Desenvolvimento {#develop}
   ...
   + [Fundamentos do Activity Stream](essentials-activities.md)
...
+ Criação {#authoring}
   ...
   + [Recurso de Fluxos de Atividades](activities.md)
   + [Recurso de blog](blog-feature.md)
   + [Recurso do Calendário](calendar.md)
