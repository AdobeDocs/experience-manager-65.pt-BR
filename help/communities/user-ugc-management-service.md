...
Para usar essas APIs, é necessário ativar o terminal **/services/social/ugcmanagement** ativando o serviço UserUgcManagement. Para ativar este serviço, instale o servlet [de](https://github.com/Adobe-Marketing-Cloud/aem-communities-ugc-migration/tree/master/bundles/communities-ugc-management-servlet) amostra disponível em [GitHub.com](https://github.com/Adobe-Marketing-Cloud/aem-communities-ugc-migration/tree/master/bundles/communities-ugc-management-servlet). Em seguida, pressione o endpoint na instância de publicação do site de suas comunidades com parâmetros apropriados usando uma solicitação http, semelhante a

**https://localhost:port/services/social/ugcmanagement?user=&lt;ID autorizável>&amp;operation=&lt;getUgc>**. No entanto, você também pode criar uma interface do usuário (interface do usuário) para gerenciar perfis de usuário e conteúdo gerado pelo usuário no sistema.
...
**deleteUserAccount(ResourceResolver resourceResolver, usuário de string) **ajuda a desativar uma conta de usuário.
