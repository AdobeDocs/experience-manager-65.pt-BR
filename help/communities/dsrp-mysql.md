...
![conexão comunitária](assets/community-connection.png)
...
![schema de atualização](assets/refresh-schema.png)
...
* Insira os seguintes valores:
   ...
   * **[!UICONTROL URI]** de conexão JDBC:  `jdbc:mysql://localhost:3306/communities?characterEncoding=UTF-8`
      ...
      Especifique o servidor no lugar de localhost se o servidor MySQL não for o mesmo que &#39;this&#39; AEM servidor *Communities* é o nome padrão do banco de dados (schema).
