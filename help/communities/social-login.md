---
title: Logon social com a Facebook e o Twitter
...
# Logon social com a Facebook e o Twitter {#social-login-with-facebook-and-twitter}

Logon social é a capacidade de apresentar a um visitante do site a opção de fazer logon com sua conta da Facebook ou da Twitter. Portanto, incluir dados Facebook ou Twitter permitidos em seu perfil de membro AEM.

![socialloginweretail](assets/socialloginweretail.png)

## Visão geral do logon social {#social-login-overview}

Para incluir login social, é *obrigatório* para criar aplicativos personalizados Facebook e Twitter.

Embora a amostra de we-retail forneça aplicativos e serviços em nuvem de exemplo da Facebook e da Twitter, eles não estão disponíveis em um [site de produção](../../help/sites-administering/production-ready.md).
...
1. **Criar** um aplicativo social e um serviço na nuvem.
   ...
   * Para oferecer suporte ao logon com o Twitter:
      ...
      * Criar e publicar um [Serviço em nuvem twitter Connect](#create-a-twitter-connect-cloud-service).
...
1. **Criar/Editar** Configuração do facebook Cloud Service.
   ...
   * **[!UICONTROL Título]** (*Obrigatório*) Insira um título de exibição que identifique o aplicativo Facebook. É recomendável usar o mesmo nome inserido como *Nome de exibição* para o aplicativo Facebook.
...
Um aplicativo Twitter configurado é necessário para habilitar o logon social do Twitter.
...
* **[!UICONTROL Permissões adicionais]**: Opcionalmente, escolha `Request email addresses from users`.
   ...
   * As instruções da twitter observam as etapas adicionais a serem seguidas.
...
### Criar um Cloud Service de conexão Twitter {#create-a-twitter-connect-cloud-service}

A variável [Aplicativo e provedor Adobe Granite OAuth](#adobe-granite-oauth-application-and-provider) instância, instanciada ao criar uma configuração do cloud service, identifica o aplicativo Twitter e os grupos de membros aos quais os novos usuários são adicionados.
...
1. Criar/editar a configuração do Twitter Cloud Service.

   ![twittersocialloging](assets/twittersocialloginpng.png)

   * **[!UICONTROL Título]**

      (*Obrigatório*) Insira um título de exibição que identifique o aplicativo Twitter. É recomendável usar o mesmo nome inserido como *Nome de exibição* para o aplicativo Twitter.
   ...
   * **[!UICONTROL Criar usuários]**
      ...
      Se marcado, o logon com uma conta do Twitter criará uma entrada de usuário AEM e a adicionará como membro aos grupos de usuários selecionados. O padrão está marcado (altamente recomendado).
...
O resultado é um [Aplicativo e provedor Adobe Granite OAuth](https://helpx.adobe.com/experience-manager/6-3/communities/using/social-login.html#adobe-granite-oauth-application-and-provider) que não exige mais modificações. O escopo padrão são as permissões padrão para logon no Twitter.
...
* Selecione **[!UICONTROL Fazer logon com a Facebook]** ou **[!UICONTROL Fazer logon com a Twitter]**.
...
* Selecionar **[!UICONTROL Perfil]**: a página Perfil exibe a imagem de avatar, o nome e o sobrenome do usuário. Ela também exibe as informações do perfil do Facebook ou Twitter de acordo com os campos/parâmetros permitidos.
...
>[!CAUTION]
>
>Tenha cuidado para não confundir o manipulador de autenticação com uma instância do Facebook ou do Twitter de *Aplicativo e provedor Adobe Granite OAuth*.

![graniteoauth1](assets/graniteoauth1.png)

### Aplicativo e provedor Adobe Granite OAuth {#adobe-granite-oauth-application-and-provider}

Quando um serviço em nuvem para o Facebook ou o Twitter é criado, uma instância de `Adobe Granite OAuth Authentication Handler` é criado.
...
Para sites da comunidade que veem centenas de milhares de usuários se registrarem usando o logon da Facebook ou do Twitter, o desempenho de passagem da consulta executada quando um visitante do site usa o logon social pode ser aprimorado adicionando o seguinte índice Oak.
