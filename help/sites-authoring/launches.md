...
>[!CAUTION]
>
>Não há suporte para reordenar componentes em uma página do Launch.
>
>Quando a página for promovida, as alterações de conteúdo serão refletidas, mas as posições dos componentes não serão alteradas.
