...
[Bloquear uma página](/help/sites-authoring/editing-content.md#locking-a-page) impede que outros autores trabalhem nela junto com você. O ícone/botão Bloquear (e Desbloquear) pode ser encontrado dentre as seguintes opções:
