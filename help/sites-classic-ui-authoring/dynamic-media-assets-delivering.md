...
* Se o site não estiver no Experience Manager, consulte [Fornecer ativos do Dynamic Media](/help/assets/delivering-dynamic-media-assets.md) na interface de usuário habilitada para toque.
