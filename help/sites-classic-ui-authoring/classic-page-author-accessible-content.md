...
>[!NOTE]
>
>Se a imagem for meramente decorativa (consulte [Criar boas alternativas em texto](#creating-good-text-alternatives)), você pode inserir um espaço no campo **Texto alternativo** usando a barra de espaço. Isso criará um `alt` , que solicitará que um leitor de tela ignore a imagem.
