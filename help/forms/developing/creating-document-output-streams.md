...
1. Defina as opções de tempo de execução de impressão necessárias para imprimir em um arquivo.
   ...
   * Especifique o arquivo chamando o método `setFileURI` do objeto PrintedOutputOptionsSpec e passando um valor de string que representa o nome e o local do arquivo. Por exemplo, se você deseja que o serviço de Saída imprima para um arquivo PostScript chamado MortgaugeForm.ps localizado em C:\Adobe, especifique C:\\Adobe\MortgageForm.ps.
