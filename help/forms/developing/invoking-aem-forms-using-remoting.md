...
se o AEM Forms estiver configurado para permitir somente o upload de documentos protegidos e o usuário não tiver a função Usuário *do aplicativo de upload de* Documentos, uma exceção será lançada. Se o usuário tiver essa função, o arquivo será carregado e o processo será chamado.
