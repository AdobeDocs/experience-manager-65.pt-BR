...
audience: end-user
user-guide-title: Guia do usuário do AEM 6.5 Forms
...
+ Instalar e configurar AEM Forms {#install-aem-forms}
   ...
   + Install AEM Forms on JEE {#jee-installation}
      ...
      + [Instalar e implantar AEM Forms no JEE usando o chave-mão JBoss](http://www.adobe.com/go/learn_aemforms_installTurnkey_65)
      ...
      + [Instalar e implantar AEM Forms no JEE para JBoss](http://www.adobe.com/go/learn_aemforms_installJBoss_65)
      + [Instalar e implantar AEM Forms no JEE para WebSphere](http://www.adobe.com/go/learn_aemforms_installWebSphere_65)
      + [Instalar e implantar AEM Forms no JEE para WebLogic](http://www.adobe.com/go/learn_aemforms_installWebLogic_65)
      ...
      + [Configurar AEM Forms em JEE no cluster JBoss](http://www.adobe.com/go/learn_aemforms_clusterJBoss_65)
      + [Configurar AEM Forms no cluster JEE no WebSphere](http://www.adobe.com/go/learn_aemforms_clusterWebSphere_65)
      + [Configurar AEM Forms no cluster JEE no WebLogic](http://www.adobe.com/go/learn_aemforms_clusterWebLogic_65)
...
+ AEM Forms de atualização {#upgrade-aem-forms}
   ...
   + Atualizar AEM Forms no JEE {#aem-forms-jee-upgrade}
      + [Preparar para atualizar AEM Forms](http://www.adobe.com/go/learn_aemforms_prepareupgrade_65)
      ...
      + [Atualização de uma versão do AEM Forms para o AEM 6.5 Forms no JEE para chave aberta JBoss](http://www.adobe.com/go/learn_aemforms_upgradeTurnkey_65)
      ...
      + [Atualização de uma versão do AEM Forms para o AEM 6.5 Forms no JEE para WebLogic](http://www.adobe.com/go/learn_aemforms_upgradeWebLogic_65)
...
+ Formulários adaptativos - Criação avançada {#adaptive-forms-advanced-authoring}
   ...
   + [Incorporar um formulário adaptável ou Comunicação interativa em AEM Sites Aplicativo de página única](/help/forms/using/embed-adaptive-form-aem-sites-spa.md)
...
+ Fluxos de trabalhos {#workflows}
   ...
   + [Logon em workflows de AEM Forms](/help/forms/using/forms-workflow-logs.md)
...
+ Referência do desenvolvedor {#developer-reference}
   ...
   + [AEM Forms na referência da API Java JEE](https://helpx.adobe.com/experience-manager/6-5/forms/programlc/javadoc/index.html)
