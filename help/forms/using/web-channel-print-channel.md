...
O canal de impressão de uma Comunicação interativa usa o modelo de formulário XFA, XDP. Um XDP foi projetado no Adobe Forms Designer. Para obter mais informações sobre como criar modelos de canal de impressão, consulte Design [de](../../forms/using/layout-design-details.md)layout. Para usar um modelo de canal de impressão em sua Comunicação interativa, é necessário carregar o modelo no servidor de formulários AEM.
...
![Imprimir canal como canal principal](assets/create_ic_print_master_new.png) ![da Web com canal de impressão como principal](assets/create_ic_print_master_web_new.png)
