...
O gerenciamento de usuários armazena dados de usuários em um banco de dados, como My Sql, Oracle, MS SQL Server e IBM DB2. Além disso, qualquer usuário que tenha feito logon pelo menos uma vez em aplicativos Forms em `https://'[server]:[port]'lc` AEM autor, o usuário será criado AEM repositório. Portanto, o gerenciamento de usuários é armazenado nos seguintes armazenamentos de dados:
...
Os dados de gerenciamento de usuários para usuários que acessaram pelo menos uma vez os aplicativos Forms em `https://'[server]:[port]'lc` também são armazenados AEM repositório.
