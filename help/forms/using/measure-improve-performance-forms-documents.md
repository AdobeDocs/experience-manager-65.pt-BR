...
Para obter etapas detalhadas, consulte [Configurar análises e relatórios para formulários](../../forms/using/configure-analytics-forms-documents.md)adaptáveis.

**Configurar o Target**

Para criar e executar testes A/B para seus formulários adaptáveis, configure o Target nos formulários AEM conforme descrito em [Configurar e integrar o Target nos formulários](../../forms/using/ab-testing-adaptive-forms.md#p-set-up-and-integrate-target-in-aem-forms-p)AEM.
...
Para obter mais detalhes sobre relatórios de análise de formulários, consulte [Visualização e compreensão dos relatórios](../../forms/using/view-understand-aem-forms-analytics-reports.md)de análise de formulários AEM.
...
Para obter mais informações sobre como criar um teste A/B para um formulário adaptável, consulte Teste [A/B de formulários](../../forms/using/ab-testing-adaptive-forms.md)adaptáveis.
