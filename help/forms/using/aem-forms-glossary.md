...
[Formulários adaptáveis](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-foundation-components/create-an-adaptive-form-on-forms-cs/creating-adaptive-form)
...
[Versão do formulário adaptável](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/adaptive-forms-core-components/add-versioning-reviews-comments)
...
## Integração do Adobe Analytics Forms

[Integração do Adobe Analytics Forms](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/forms/integrate/services/enable-adobe-analytics-adaptive-form-using-experience-cloud-setup-automation)
...
## Pacote complementar do AEM Forms

[Pacote complementar do AEM Forms](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/install-aem-forms/osgi-installation/installing-configuring-aem-forms-osgi)

Um aplicativo implantado no Adobe Experience Manager (AEM) como um pacote, contendo serviços (provedores de API) e servlets ou JSPs gerenciados pela estrutura do AEM Sling.

## AEM Forms no JEE

[AEM Forms no JEE](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/install-aem-forms/jee-installation/aem-forms-jee-supported-platforms)
...
O AEM Forms no ambiente OSGi é um autor padrão do AEM ou uma publicação do AEM com um pacote do AEM Forms implantado. Você pode executar o AEM Forms no OSGi em um único ambiente de servidor, Farm e configurações em cluster. A configuração do cluster está disponível somente para instâncias do AEM Author.
...
## Serviços de documento da AEM Forms 6.5

[Serviços de documento da AEM Forms 6.5](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/use-document-services/overview-aem-document-services)

APIs fornecidas pela camada da Web do AEM Forms para consumo remoto por clientes baseados em HTTP, como o SDK móvel de formulários.Funcionalidades no AEM Forms que permitem a criação, montagem, distribuição e arquivamento de documentos do PDF, adição de assinaturas digitais e decodificação de Forms com código de barras.

| **Nome do Serviço** | **Descrição** | **Link de Documentação** |
|------------------------------|---------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------|
| **Serviço do Forms** | Renderize o PDF forms usando modelos e XML, integre dados de formulário para importação/exportação e aceite renderização baseada em fragmento. | [Documentação de serviço do Forms](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/use-document-services/output-service) |
| **Serviço de saída** | Gera documentos mesclando dados com modelos em formatos como PDF, PCL ou PostScript. | [Documentação do Serviço de Saída](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/use-document-services/output-service) |
| **Serviço de Assembler** | Combina, reorganiza, valida e aumenta documentos PDF e XDP. | [Documentação do Serviço de Assembler](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/use-document-services/assembler-service) |
| **Serviço ConvertPDF** | Converte documentos do PDF em PostScript ou formatos de imagem como PNG, JPEG ou TIFF. | [Documentação do ConvertPDF Service](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/use-document-services/using-convertpdf-service) |
| **Serviço Forms com código de barras** | Extrai dados de códigos de barras em arquivos TIFF e PDF para automatizar processos de captura de dados. | [Documentação de serviço do Forms com códigos de barras](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/use-document-services/using-barcoded-forms-service) |
| **DocAssurance Service** | Criptografa, decodifica, assina digitalmente e aplica políticas de segurança de documentos aos PDFs. | [Documentação do DocAssurance Service](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/use-document-services/overview-aem-document-services#doc-assurance-service) |
| **Serviço PDF Generator** | Converte formatos de arquivo nativos (por exemplo: Microsoft Word, Excel) em documentos do PDF. | [Documentação de serviço do PDF Generator](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/use-document-services/aem-document-services-programmatically#pdfgeneratorservice) |

## APIs de comunicação do Forms as a Cloud Service

[APIs de comunicação do Forms as a Cloud Service](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/forms/using-communications/aem-forms-cloud-service-communications-introduction)

O AEM Forms as a Cloud Service fornece ferramentas avançadas para gerenciar formulários e fluxos de trabalho de comunicação, oferecendo suporte à criação contínua de formulários digitais, captura de dados e comunicações personalizadas. As APIs de comunicação na nuvem fornecem geração, manipulação, validação e integração seguras de documentos sob demanda e em lote com sistemas externos por meio de HTTP, garantindo operações simplificadas e seguras.

| **Nome do Serviço** | **Descrição** | **Link de Documentação** |
|-------------------------------|------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------|
| **Geração de documentos** | Combine um modelo (XFA ou PDF) com dados XML para gerar documentos no PDF e Formatos de impressão como formatos PS, PCL, DPL, IPL e ZPL. | [Documentação de geração de documentos](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/using-communications/aem-forms-cloud-service-communications-introduction.html#document-generation) |
| **Manipulação de documentos** | Combine e reorganize documentos do PDF. | [Documentação de manipulação de documentos](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/forms/using-communications/aem-forms-cloud-service-communications-introduction#document-manipulation) |
| **Conversão de documentos** | Converta um PDF em PDF/A e verifique a conformidade com o PDF/A. | [Documentação de conversão de documentos](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/forms/using-communications/aem-forms-cloud-service-communications-introduction#document-conversion) |
| **Assurance do documento** | Adicione ou remova campos de assinatura, assine, certifique, criptografe, descriptografe e aplique direitos de uso a documentos do PDF. | [Documentação do Assurance do documento](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/forms/using-communications/aem-forms-cloud-service-communications-introduction#doc-assurance) |
| **Assinaturas Digitais** | Integra o Adobe Sign para obter uma assinatura eletrônica segura de formulários e documentos. | [Documentação de assinaturas digitais](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/using-communications/aem-forms-cloud-service-communications-introduction.html#digital-signatures) |
...
## Instância de criação

[Instância de criação](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/publish-process-aem-forms/publishing-unpublishing-forms)
...
## Front-end de criação

[Front-end de criação](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/install-aem-forms/aem-forms-architecture-deployment#architecture)

Uma interface de usuário para criação e gerenciamento de formulários no AEM Forms.

## Bloco de formulário adaptável

[Bloco de formulário adaptável](https://experienceleague.adobe.com/pt-br/docs/experience-manager-cloud-service/content/edge-delivery/build-forms/forms-references/form-components)
...
[Componentes principais](https://experienceleague.adobe.com/en/docs/experience-manager-core-components/using/adaptive-forms/introduction)
...
[Gerenciamento de correspondência](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/letters-correspondences/cm-overview)
...
O Java Content Repository (JCR) integrado na AEM, que armazena dados estruturados e não estruturados, permitindo o armazenamento hierárquico de conteúdo, modelos e configurações.

## Componente personalizado

[Componente personalizado](https://experienceleague.adobe.com/en/docs/experience-manager-core-components/using/adaptive-forms/customize-adaptive-forms-core-components)
...
## XCI Personalizado (Informações de Configuração XML)

[XCI Personalizado (Informações de Configuração XML)](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/administrator-help/configure-forms/specifying-xci-configuration-options)
...
[Integração de dados](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/form-data-model/data-integration)
...
[Fonte de dados](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/form-data-model/configure-data-sources)
...
[Fragmentos do documento](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/letters-correspondences/lists)
...
[Documento de registro (DoR)](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-foundation-components/generate-document-of-record-for-non-xfa-based-adaptive-forms)
...
[Integração do Forms](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/form-data-model/data-integration)
...
[Revisão do formulário](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-foundation-components/create-reviews-forms)
...
## Localização de formulários

[Localização de formulários](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-foundation-components/supporting-new-language-localization)
...
[Portal de formulários](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/use-forms-portal/creating-form-portal-page)
...
## Front-end de representação e envio de formulário

[Front-end de representação e envio de formulário](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/install-aem-forms/aem-forms-architecture-deployment#architecture)
...
[Conjuntos de formulários](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/html5-forms/formset-in-aem-forms)
...
[Designer do Forms](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/forms/using-communications/installing-configuring-designer)
...
## Fluxo de trabalho centrado no Forms

[Fluxo de trabalho centrado no Forms](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/workflows/aem-forms-workflow)
...
[Comunicação interativa](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/getting-started/interactive-communications-overview)
...
[Cartas](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/letters-correspondences/create-letter#create-a-letter-template)
...
[Metadados no AEM Forms](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/manage-administer-aem-forms/manage-form-metadata)
...
[Instância de publicação](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/publish-process-aem-forms/publishing-unpublishing-forms)
...
[Editor de regras](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-core-components/create-an-adaptive-form-on-forms-cs/rule-editor-core-components/rule-editor-core-components)
...
## Rabiscar assinaturas

[Rabiscar assinaturas](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-foundation-components/add-components-to-an-adaptive-form/signing-forms-using-scribble)
...
## Ação de envio no AEM Forms

[Ação de envio no AEM Forms](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/adaptive-forms-basic-authoring/configuring-submit-actions)
...
[Modelo](https://experienceleague.adobe.com/en/docs/experience-manager-core-components/using/adaptive-forms/sample-themes-templates-form-data-models-core-components)
...
[Camada da Web](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/install-aem-forms/aem-forms-architecture-deployment#architecture)
...
## XDP (Pacote de dados XML)

[XDP (Pacote de dados XML)](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/manage-administer-aem-forms/get-xdp-pdf-documents-aem)

Um formato de arquivo usado no AEM Forms para projetar e estruturar formulários, permitindo a renderização como PDFs ou HTML e, ao mesmo tempo, suportando conteúdo dinâmico e interatividade.

## XFA (XML Forms Architecture, arquitetura XML do)

[XFA (XML Forms Architecture, arquitetura XML do)](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/adaptive-forms-basic-authoring/creating-adaptive-form#create-an-adaptive-form-based-on-an-xfa-form-template)

Uma tecnologia herdada para criar PDF forms interativo e dinâmico. Os formulários XFA permitem recursos avançados, como ajustes de layout dinâmicos, scripts e integração contínua com sistemas de back-end.

## Esquema XML ou JSON

[Esquema XML ou JSON](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/adaptive-forms-basic-authoring/creating-adaptive-form#create-an-adaptive-form-based-on-xml-or-json-schema)
