...
1. Um editor de texto é aberto e insere o texto. Use a barra de ferramentas na parte superior da página para formatar o texto, inserir condições, links e quebras de página.
   ...
   * **Link**: Inserir  [](#insert-hyperlink) hypertextlink no texto.
...
2. Toque em **[!UICONTROL Link]**. Toque no campo **[!UICONTROL Texto alternativo]** para remover o nome ou o texto do objeto do modelo de dados existente.
