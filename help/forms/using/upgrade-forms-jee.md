...
1. Dependendo do ambiente existente e do servidor de aplicativos, escolha um dos documentos a seguir e siga as instruções.
   ...
   * [Atualização do AEM 6.3 ou AEM 6.4 Forms AEM para o 6.5 Forms para WebSphere](https://www.adobe.com/go/learn_aemforms_upgradeWebSphere_65)
   * [Atualização do AEM 6.3 ou AEM 6.4 Forms AEM para o 6.5 Forms para o JBoss Turnkey](https://www.adobe.com/go/learn_aemforms_upgradeTurnkey_65)
