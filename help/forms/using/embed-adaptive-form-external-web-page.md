...
* Quando AEM servidor e a página da Web estiverem em domínios diferentes, execute as etapas listadas na seção , [permitir que o AEM Forms forneça formulários adaptáveis a um site de domínio cruzado](#cross-site).
...
* Use `[getData](https://helpx.adobe.com/experience-manager/6-3/forms/javascript-api/GuideBridge.html)` API para obter a representação XML ou JSON dos dados de formulário no cliente.
* Use `[unloadAdaptiveForm](https://helpx.adobe.com/experience-manager/6-3/forms/javascript-api/GuideBridge.html)` API para descarregar o formulário adaptável do HTML DOM.
* Configure o cabeçalho access-control-origin ao enviar resposta de AEM servidor.

## Permitir que o AEM Forms forneça formulários adaptáveis a um site de domínio cruzado {#cross-site}
...
1. Localize e abra o **Filtro de referenciador do Apache Sling** configuração.
