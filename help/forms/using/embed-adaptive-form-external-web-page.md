...
* Quando AEM servidor e a página da Web estiverem em domínios diferentes, execute as etapas listadas na seção, [ative a AEM Forms para fornecer formulários adaptáveis a um site](#cross-site)entre domínios.
