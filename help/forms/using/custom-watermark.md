...
Para ativar a marca d&#39;água no PDF de visualização, selecione a opção **[!UICONTROL Aplicar marca d&#39;água]** durante visualização nas Configurações **[!UICONTROL de gerenciamento de]** correspondência em https://[server]:[port]/system/console/configMgr.
