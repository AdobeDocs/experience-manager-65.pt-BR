...
* Especificar quais configurações de tipo de arquivo usar por padrão (consulte [Importação e exportação de arquivos de configuração do PDF Generator](https://helpx.adobe.com/aem-forms/6-2/admin-help/importing-exporting-pdf-generator-configuration.html))
...
* [Habilitar o suporte ao PDF/A](https://helpx.adobe.com/aem-forms/6-2/admin-help/enable-pdf-a-support.html)
...
1. Preencha as informações necessárias nestas seções:
   ...
   [Importação e exportação de arquivos de configuração do PDF Generator](https://helpx.adobe.com/aem-forms/6-2/admin-help/importing-exporting-pdf-generator-configuration.html)
...
[Definições do OpenOffice](/help/forms/using/admin-help/configuring-file-type-settings2.md#openoffice-settings)
...
[Configurações de outros aplicativos (somente Windows)](/help/forms/using/admin-help/configuring-file-type-settings2.md#other-applications-settings-windows-only)
   ...
   Para acessar outra seção, clique no link na página da Web ou use o **[!UICONTROL Próximo]**ou **[!UICONTROL Anterior]** botões.
...
Essas opções determinam como os arquivos do Microsoft PowerPoint são convertidos. Para obter instruções sobre como acessar essas opções, consulte [Criar ou editar configurações de tipo de arquivo](/help/forms/using/admin-help/configuring-file-type-settings2.md#create-or-edit-file-type-settings).
...
Essas opções determinam como os arquivos AutoCAD são convertidos. Para obter instruções sobre como acessar essas opções, consulte [Criar ou editar configurações de tipo de arquivo](/help/forms/using/admin-help/configuring-file-type-settings2.md#create-or-edit-file-type-settings).
...
**[!UICONTROL Criar arquivo compatível com PDF/E-1]**: Cria um arquivo compatível com PDF/E-1. PDF/E é uma norma ISO para o intercâmbio de documentação técnica e de engenharia. Para obter mais informações sobre PDF/E-1, consulte [Adobe e padrões da indústria](https://www.adobe.com/enterprise/standards/index.html).
...
Essas opções determinam como os arquivos OpenOffice são convertidos. Para obter instruções sobre como acessar essas opções, consulte [Criar ou editar configurações de tipo de arquivo](/help/forms/using/admin-help/configuring-file-type-settings2.md#create-or-edit-file-type-settings).
