...
[Configurações de projeto do Microsoft (somente Windows)](/help/forms/using/admin-help/configuring-file-type-settings2.md#microsoft-project-settings-windows-only)
...
1. Se quiser incorporar somente os subconjuntos em uso das fontes incorporadas, selecione **Subdefinir todas as fontes incorporadas**.
   ...
   >[!NOTE]
   >
   >*Se estiver usando essa opção em combinação com **Desincorporar algumas fontes**, fontes na **Adicionar fontes para desincorporar**ainda estão completamente desincorporadas.*
...
Essas opções determinam como os arquivos do AutoCAD são convertidos. Para obter instruções sobre como acessar essas opções, consulte [Criar ou editar configurações de tipo de arquivo](/help/forms/using/admin-help/configuring-file-type-settings2.md#create-or-edit-file-type-settings).
...
**[!UICONTROL Criar arquivo compatível com PDF/E-1]**: cria um arquivo compatível com PDF/E-1. PDF/E é um padrão ISO para troca de documentação técnica e de engenharia. Para obter mais informações sobre o PDF/E-1, consulte [Adobe e padrões do setor](https://www.adobe.com/enterprise/standards/index.html).
