...
>[!NOTE]
>
>Verifique se o diretório temporário está no sistema de arquivos local. AEM formulários não oferecem suporte para um diretório temporário em um local remoto.
