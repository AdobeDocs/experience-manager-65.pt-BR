...
Ao criar um estilo em um campo, todos os campos, como idade, nome, endereço, são estilizados.
   ...
   * **Exibir CSS**: Permite que você visualize o CSS do componente selecionado
   Além disso, na Barra lateral, na parte inferior, uma seta está presente. Ao clicar na seta, você terá mais duas opções: **Simular sucesso** e **Erro Simulado.** Essas opções, juntamente com as opções descritas acima, são discutidas em detalhes [below](../../forms/using/themes.md#using-rail).
...
1. Na guia General , navegue e selecione um formulário ou uma comunicação interativa para a **Formulário/documento adaptável** campo.
...
O Editor de Temas permite que você edite um tema que você criou ou carregou. Navegar para **Forms &amp; Documents > Temas** e selecione um tema e abra-o. O tema é aberto no Editor de Temas.
...
Use **Dimension &amp; Posição** na barra lateral para personalizar o tamanho do componente. Certifique-se de que o estado seja **Padrão**.
...
1. Use o **Erro Simular** na parte inferior da barra lateral para ver a aparência do estilo na edição.
...
Agora é possível usar fontes disponíveis em um serviço da Web em um formulário adaptável ou comunicação interativa. Pronto para uso, [Adobe Fonts](https://fonts.adobe.com/), um serviço da Web Adobe está disponível. Para usar o Adobe Fonts, crie um kit, adicione fontes e obtenha a ID do Kit de [Adobe Fonts](https://fonts.adobe.com/).
...
1. No **Cloud Services** navegue e abra a página **Adobe Fonts** opção. Abra a pasta de configuração e clique em **Criar**.
...
1. No editor de temas, navegue até **Opções de Tema** ![theme-options](assets/theme-options.png) > **Configurar**.
1. Em **Configuração do Adobe Fonts** , selecione um kit e clique em **Salvar**.
...
1. Abrir **Serviço de Configuração de Tema de Formulário Adaptável**.
...
1. Selecione seu tema no **Tema de formulário adaptável** e clique em **Concluído** ![botão de seleção](assets/check-button.png).
...
1. No modo de edição, selecione um componente e clique em ![nível de campo](assets/field-level.png) >**Contêiner de documento** e, em seguida, clique em ![cmppr](assets/cmppr.png).

   É possível editar as propriedades do formulário na barra lateral.

1. Na barra lateral, abaixo **Básico**, selecione seu tema no **Tema** e clique em **Concluído** ![botão de seleção](assets/check-button.png)
...
* **Evitar ativos de outro Tema**
   ...
   Ao editar um tema, você pode procurar e adicionar ativos (como imagens) de outros temas. Por exemplo, você está editando o plano de fundo de uma página. Por exemplo, ao selecionar **Página** ![botão editar](assets/edit-button.png)> **Histórico** > **Adicionar** > **Imagem**, você verá uma caixa de diálogo que permite navegar e adicionar imagens em outro tema.
...
* **Uso da clientlib base, do editor de temas e do estilo em linha**
   ...
   * **Clientlib base**:
      ...
      1. Navegar para **Experience Manager > Forms > Temas**.
...
Consulte [Obter aparência específica usando Temas](#specific-af-appearance)
   ...
   * **Estilo em linha:**
      ...
      É possível criar estilos de componentes usando o modo Estilo no formulário ou o editor multicanal de comunicação interativo ao trabalhar com um formulário. Usar o modo de estilo para alterar o estilo do componente de formulário substitui o estilo especificado no tema. Se quiser alterar o estilo de determinados componentes de um formulário específico, consulte [Estilo em linha dos componentes](../../forms/using/inline-style-adaptive-forms.md).
