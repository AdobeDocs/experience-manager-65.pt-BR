...
* [Barra de ferramentas Página](#page-toolbar)
...
* **Navegador** de conteúdo No navegador de conteúdo, você pode ver
   ...
   * **Objetos de formulário** Mostra a hierarquia de objetos do formulário. O autor pode navegar até um componente de formulário específico tocando nesse elemento na Árvore de objetos de formulário. O autor pode pesquisar objetos e reorganizá-los desta árvore.
...
* **Navegador de propriedades**
   ...
   Selecione um componente, toque em nível ![de](assets/field-level.png) campo > Contêiner **de formulário** adaptável e, em seguida, toque em ![cmppr](assets/cmppr.png).
...
<table>
 <tbody>
  ...
  <tr>
   <td>Captcha</td>
   <td>Adiciona validação CAPTCHA usando o serviço Google reCAPTCHA. Para obter detalhes, consulte <a href="../../forms/using/captcha-adaptive-forms.md" target="_blank">Uso do CAPTCHA em formulários</a>adaptáveis.</td>
  </tr>
  <tr>
   <td>Gráfico</td>
  ...
  <tr>
   <td>(Obsoleto) Assinatura do rabisco</td>
...
* O componente de anexo Arquivo, por padrão, permite que um usuário anexe apenas um arquivo. Entretanto, é possível configurar as propriedades do componente para suportar vários anexos. Além disso, se um usuário anexar vários arquivos com o mesmo nome de arquivo, os anexos podem causar alguns problemas. Portanto, é recomendável associar um identificador exclusivo para cada anexo enviado no envio do formulário. Para isso:
   ...
   1. No servidor do AEM Forms, navegue até **Adobe Experience Manager > Ferramentas > Operações > Console** da Web.
   1. Localize e toque em Serviço **de configuração de formulários** adaptáveis.
   1. Na caixa de diálogo Adaptive Forms Configuration Service, ative **Tornar nomes de arquivos únicos**. Por padrão, ele é desativado.
...
* **Opções** de ![tema de informações](assets/theme-options.png)da página: Permite exibir as propriedades da página, publicar/desfazer a publicação de um formulário, iniciar um fluxo de trabalho de formulário e abrir o formulário na interface clássica.

* **Régua** de emulador ![](assets/ruler.png): Permite que você emule a aparência do formulário para tamanhos de exibição diferentes, como tablets e telefones.
...
* **guideContainer**: A raiz de um formulário adaptável, que está marcada como **Início do formulário** adaptável na interface de usuário do formulário adaptável. Neste componente, você pode especificar:
