...
1. Abra as propriedades do container **** de formulário adaptável. No navegador de propriedades, navegue até **[!UICONTROL Básico]** > Tema **[!UICONTROL de formulário]** adaptável. O campo Tema **[!UICONTROL de formulário]** adaptável lista todos os temas predefinidos e personalizados. Por padrão, o tema Tela de desenho é aplicado.
1. Selecione um tema no campo Tema **[!UICONTROL de formulário]** adaptável. Por exemplo, tema **de** Pesquisa. Toque em ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png) para aplicar o tema selecionado.
...
1. Altere o logotipo e o texto do cabeçalho existentes. Para remover o logotipo:
   ...
   1. Toque na imagem do logotipo no componente do [!UICONTROL cabeçalho] e toque em ![cmppr](assets/cmppr.png) **[!UICONTROL propriedades]**. Na propriedade [!UICONTROL image] , toque em X para remover a imagem do logotipo existente.
   1. Toque em **[!UICONTROL carregar]**, selecione o logotipo.png e toque em ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png) para salvar as alterações. A imagem foi baixada na seção [Antes do start](/help/forms/using/style-your-adaptive-form.md#before-you-start) .
   1. Toque no texto do cabeçalho `We.Retail`e toque em ![aem_6_3_edit](assets/aem_6_3_edit.png) **[!UICONTROL edit]**. Altere o texto do cabeçalho para `we retail`. Aplique a formatação em negrito somente `we`em `we retail`.
...
1. Remova o título e adicione texto de espaço reservado:
   ...
   1. Copie o conteúdo do campo **[!UICONTROL Título]** para o campo Texto **[!UICONTROL de]** espaço reservado.
   1. Exclua o conteúdo do campo **[!UICONTROL Título]** e toque em ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
...
1. Toque em **[!UICONTROL Criar]** e selecione **[!UICONTROL Tema]**. A página [!UICONTROL Criar tema] com os campos necessários para criar um tema é exibida. Os campos **[!UICONTROL Título]** e **[!UICONTROL Nome]** são obrigatórios:
...
1. Toque em Opções **[!UICONTROL de]** tema Opções ![de](assets/theme-options.png) tema **[!UICONTROL >]** Configurar. No campo Formulário **[!UICONTROL de]** Pré-visualização, selecione o formulário adaptável **Shipping-address-add-update-form** , toque em ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png)e em **[!UICONTROL Salvar]**. Agora, o editor de temas está configurado para usar seu próprio formulário adaptativo em vez do formulário adaptativo padrão. Toque em **[!UICONTROL Cancelar]** para retornar ao editor de temas.
...
1. Navegue pela opção **[!UICONTROL Cabeçalho]** > **[!UICONTROL Texto]** no painel Seletores. O painel Seletores fica à esquerda do editor de temas. Se o painel não estiver visível, toque em ![alternar painel lateral](assets/toggle-side-panel.png) Alternar painel lateral.

1. Defina as seguintes propriedades no acordeão de **[!UICONTROL texto]** e toque em ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
...
1. Toque no widget [!UICONTROL cabeçalho] e toque em **[!UICONTROL Cabeçalho]**. As opções para estilizar o widget Cabeçalho são exibidas à esquerda. Expanda a opção **[!UICONTROL Dimension e posição]** , defina a **[!UICONTROL altura]** como `120px`e toque em ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
1. Expanda a opção **[!UICONTROL Plano de fundo]** do widget de cabeçalho e defina a Cor **[!UICONTROL de]** plano de fundo como `F6921E.`
...
1. No editor de temas, toque no logotipo no cabeçalho e toque em Logotipo **[!UICONTROL do]** cabeçalho. Expanda a opção Dimension e posição, defina as seguintes propriedades e toque em ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
...
1. Toque no widget de rodapé e toque em **[!UICONTROL Rodapé]**. Expanda a opção **[!UICONTROL Plano de fundo]** , defina a Cor **[!UICONTROL de]** plano de fundo como `F6921E`e toque em ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
...
1. Toque no campo ID **[!UICONTROL do]** cliente e toque na opção Widget **** de campo. Defina as seguintes propriedades e toque em ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
...
1. Toque na área vazia acima do campo ID **[!UICONTROL do]** cliente e toque em Container **[!UICONTROL do painel]** responsivo. Defina **[!UICONTROL Background]** > **[!UICONTROL Background Color]** como F1F2F2. Toque em ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
...
1. Toque no botão **[!UICONTROL Anexar]** e toque em ![aem_6_3_](assets/aem_6_3_edit.png)editicon. Defina as seguintes propriedades na opção **[!UICONTROL Dimension e Posição]** :
...
1. Toque na opção prova **[!UICONTROL de endereço aprovada pelo]** Governo e toque em ![aem_6_3_](assets/aem_6_3_edit.png)editicon. Defina as seguintes propriedades:
