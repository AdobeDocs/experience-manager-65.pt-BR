...
1. Selecione um tema no **[!UICONTROL Tema do formulário adaptável]** campo. Por exemplo, **Tema da pesquisa**. Selecionar ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png) para poder aplicar o tema selecionado.
...
1. Altere o logotipo existente e o texto do cabeçalho. Para remover o logotipo:
   ...
   1. Selecione a imagem do logotipo na [!UICONTROL cabeçalho] e selecione ![cmppr](assets/cmppr.png) **[!UICONTROL propriedades]**. No [!UICONTROL imagem] selecione X para remover a imagem de logotipo existente.
   1. Selecionar **[!UICONTROL upload]**, selecione logo.png e selecione ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png) para salvar as alterações. A imagem foi baixada no [Antes de começar](/help/forms/using/style-your-adaptive-form.md#before-you-start) seção.
   1. Selecione o texto do cabeçalho, `We.Retail`e selecione ![aem_6_3_edit](assets/aem_6_3_edit.png) **[!UICONTROL editar]**. Alterar texto do cabeçalho para `we retail`. Aplicar formatação em negrito somente a `we`in `we retail`.
...
1. Remover título e adicionar texto de espaço reservado:
   ...
   1. Exclua o conteúdo do **[!UICONTROL Título]** e selecione ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
...
1. Selecionar **[!UICONTROL Criar]** e selecione **[!UICONTROL Tema]**. A variável [!UICONTROL Criar tema] página com os campos necessários para criar um tema é exibida. A variável **[!UICONTROL Título]** e **[!UICONTROL Nome]** os campos são obrigatórios:
...
1. Selecione **[!UICONTROL Criar]**. Um tema é criado e uma caixa de diálogo para abrir o formulário para edição é exibida. Selecionar **[!UICONTROL Abertura]** para abrir o tema recém-criado em uma nova guia. O tema é aberto no editor de temas. Para o estilo, o editor de temas usa um formulário adaptável pronto para uso enviado com AEM [!DNL Forms].
...
1. Selecionar **[!UICONTROL Opções de tema]** ![theme-options](assets/theme-options.png) > **[!UICONTROL Configurar]**. No **[!UICONTROL Visualizar Formulário]** selecione o **endereço-entrega-adicionar-atualizar-formulário** formulário adaptável, selecione ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png), selecione **[!UICONTROL Salvar]**. Agora, o editor de temas é configurado para usar seu próprio formulário adaptável em vez do formulário adaptável padrão. Selecionar **[!UICONTROL Cancelar]** para retornar ao editor de temas.
...
1. Navegue pela **[!UICONTROL Cabeçalho]** > **[!UICONTROL Texto]** no painel Seletores. O painel Seletores está à esquerda do editor de tema. Se o painel não estiver visível, selecione ![ativar/desativar painel lateral](assets/toggle-side-panel.png) Alternar painel lateral.

1. Defina as seguintes propriedades no **[!UICONTROL Texto]** e selecione ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
...
1. Expanda a **[!UICONTROL Histórico]** do widget cabeçalho, defina o **[!UICONTROL Cor do plano de fundo]** para `F6921E.`
   ...
   Focalizar **[!UICONTROL Imagem e Gradiente]** > **[!UICONTROL + Adicionar]**, selecione **[!UICONTROL Imagem]**. Defina as seguintes propriedades e selecione ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
...
1. No editor de temas, selecione o logotipo no cabeçalho e **[!UICONTROL Logotipo de cabeçalho]**. Expanda a opção Dimension e Posição, defina as seguintes propriedades e selecione ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
    ...
    <tbody> 
     ...
     <tr> 
      ...
      <td> 
       ...
       </ul> <p><strong>Dica:</strong> Selecione o <img src="assets/link.png"> ícone de link para fornecer um valor diferente para cada campo.<br /> </p> </td> 
     </tr> 
     <tr> 
      <td>Altura</td> 
      <td>4,75rem</td> 
...
1. Selecione o widget de rodapé e **[!UICONTROL Rodapé]**. Expanda a **[!UICONTROL Histórico]** , defina o **[!UICONTROL Cor do plano de fundo]** para `F6921E`e selecione ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
...
1. Selecione o **[!UICONTROL ID do cliente]** e selecione o **[!UICONTROL Widget de campo]** opção. Defina as seguintes propriedades e selecione ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
...
1. Selecione a área vazia acima da **[!UICONTROL ID do cliente]** e selecione **[!UICONTROL Contêiner do painel responsivo]**. Defina o **[!UICONTROL Histórico]** > **[!UICONTROL Cor do plano de fundo]** a F1F2F2. Selecionar ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
...
1. Selecione o **[!UICONTROL Enviar]** e selecione o botão **[!UICONTROL Botão]** opção. Defina as seguintes propriedades e selecione ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
...
1. Selecione o **[!UICONTROL Anexar]** e selecione o botão ![aem_6_3_edit](assets/aem_6_3_edit.png)ícone. Defina as seguintes propriedades no **[!UICONTROL Dimension e Posição]** acordeão:
...
1. Selecione o **[!UICONTROL Enviar]** e selecione o botão ![aem_6_3_edit](assets/aem_6_3_edit.png) ícone. Defina as seguintes propriedades:
