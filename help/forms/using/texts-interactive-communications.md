...
* Para permitir que os agentes editem o valor de uma propriedade do modelo de dados de formulário na interface do usuário do agente enquanto [Prepare e envie Interative Communication](/help/forms/using/prepare-send-interactive-communication.md) usando a interface do agente, toque no ícone de bloqueio **[D]** dessa propriedade e verifique se ela está em um estado desbloqueado. O estado padrão da propriedade está bloqueado e um agente não pode editar a propriedade na interface do agente.
