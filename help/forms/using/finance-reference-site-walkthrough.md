...
**Sarah acessa o aplicativo de cartão de crédito do dispositivo móvel**
...
* [Criação de formulários adaptáveis usando o Esquema XML](../../forms/using/adaptive-form-xml-schema-form-model.md)
...
Sarah volta mais tarde e encontra um email do We.Finance. Ela clica no botão **Retomar** no e-mail que a leva ao rascunho do cartão de crédito. As informações que ela preencheu anteriormente vêm pré-preenchidas. Preenche o formulário restante, assina o pedido e submete-o.

![resume-1](assets/resume-1.png)

Como alternativa, ela pode acessar seu rascunho de aplicativo em **Meus formulários** na página inicial We.Finance.
...
Para obter mais informações sobre como interpretar o painel de análise, consulte [Visualização e compreensão dos relatórios](../../forms/using/view-understand-aem-forms-analytics-reports.md)de análise do AEM Forms.
...
Para que você possa visualizar e explorar o relatório de análise, estamos fornecendo dados semente para o aplicativo de cartão de crédito no site de referência. Antes de usar dados semente, consulte [Configurar o Analytics](../../forms/using/setup-reference-sites.md#configureanalytics). Execute as seguintes etapas na instância do autor para exibir o relatório com os dados semente:
...
Para configurar o Target no servidor de formulários AEM, consulte [Configurar e integrar o Target no AEM Forms](../../forms/using/ab-testing-adaptive-forms.md#set%20up%20and%20integrate%20target%20in%20aem%20forms).
...
Para obter informações sobre como usar a Caixa de entrada do AEM para tarefas de fluxo de trabalho centradas em formulários, consulte [Gerenciar aplicativos e tarefas de formulários na Caixa de entrada](../../forms/using/manage-applications-inbox.md)do AEM.
...
Para que você possa visualizar e explorar o relatório de análise, estamos fornecendo dados semente para o aplicativo de hipoteca no site de referência. Antes de usar dados semente, consulte [Configurar o Analytics](../../forms/using/setup-reference-sites.md#configureanalytics). Execute as seguintes etapas na instância do autor para exibir o relatório com os dados semente:
...
Para baixar a versão PDF, vá para a comunicação interativa do Fundo de crescimento do chip azul `https://[publishHost]:[ publishPort]/content/forms/af/we-finance/wealth-management/wealth-management/channels/web.html`, toque em Download PDF.
