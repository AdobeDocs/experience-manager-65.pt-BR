...
1. Toque em **Abrir** para visualização dos detalhes da tarefa e realizar ações. A visualização detalhada da tarefa é aberta. Nesta visualização, você pode visualização detalhes da tarefa e realizar ações na tarefa.
...
1. Use um dos seguintes métodos para adicionar índices:
   ...
   * Crie os seguintes nós no CRX DE em `/oak:index/workflowDataLucene/indexRules/granite:InboxItem/properties` com as respectivas propriedades, conforme especificado na tabela a seguir:
