...
1. Select the **[!UICONTROL Adobe Sign] Field** ![aem_6_3_adobesign](assets/aem_6_3_adobesign.png) icon. Ele exibe opções para selecionar e adicionar [!DNL Adobe Sign] campos.
