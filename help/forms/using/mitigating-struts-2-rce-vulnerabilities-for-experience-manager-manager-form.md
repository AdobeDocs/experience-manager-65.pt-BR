---
title: Reduzindo vulnerabilidades de RCE do Struts 2 para Experience Manager Forms
description: Reduzindo vulnerabilidades de RCE do Struts 2 para Experience Manager Forms
...
# Reduzindo vulnerabilidades de RCE do Struts 2 para Experience Manager Forms {#mitigatin-struts2-rce-vulnerabilities-for-aem-forms}
...
1. Use a ferramenta de patch manual para pesquisar, listar e substituir todos os arquivos jar struts2. Para pesquisar e substituir o arquivo jar struts2-core-2.5.30 e struts2-core.jar:
...
1. Execute o seguinte comando para listar todos os arquivos jar struts2:
       ...
       Substitua o caminho no comando acima pelo caminho do seu servidor de formulários AEM.
   
1. Execute os seguintes comandos na ordem listada para substituição recursiva no local:
       ...
       Substitua o caminho no comando acima pelo caminho do seu servidor de formulários AEM e o arquivo &quot;struts2-core-2.5.33.jar&quot;.
...
1. Execute os seguintes comandos para substituição recursiva no local:
