...
* Se o servidor do AEM Forms for executado lentamente mesmo após a exclusão dos diretórios sugeridos, exclua também o arquivo executável Java (java.exe).
>
