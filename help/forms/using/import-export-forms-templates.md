...
1. Na caixa de diálogo , navegue e selecione o pacote ou o arquivo a ser importado. Você também pode selecionar PDF document, XSDs, imagens, folhas de estilos e formulários XDP. Toque **Abrir**. A pasta ou o nome de arquivo selecionado não deve incluir caracteres especiais.
...
>[!NOTE]
>
>Ao importar ativos antigos de Gerenciamento de correspondência para migração, faça logon usando uma conta de administrador. Para obter mais informações sobre Migração de ativos antigos de gerenciamento de correspondência, consulte [Migrar ativos do Gerenciamento de correspondência para AEM formulários 6.1](/help/forms/using/migration-utility.md).
