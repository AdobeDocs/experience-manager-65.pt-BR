...
>[!NOTE]
>
>Essa opção estará disponível se o campo `isMustOpenToComplete` não estiver selecionado na etapa `Assign Task` no Workbench, durante a criação de um processo.
