...
>[!NOTE]
>
>Quando você abre um formulário adaptável criado usando o modelo avançado para edição, uma mensagem de erro é exibida. O modelo avançado tem um componente Etapa de assinatura e a Adobe Sign está habilitada para ele por padrão. Crie e selecione uma [configuração de nuvem do Adobe Sign](/help/forms/using/adobe-sign-integration-adaptive-forms.md) e [configure um assinante](working-with-adobe-sign.md#addsignerstoanadaptiveform) para resolver o erro.
