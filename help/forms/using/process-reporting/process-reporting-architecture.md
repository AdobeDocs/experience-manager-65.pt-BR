...
Para obter uma introdução à interface do usuário do Process Relatórios, consulte [Processar interface do usuário do Relatórios](/help/forms/using/process-reporting/introduction-process-reporting.md).
