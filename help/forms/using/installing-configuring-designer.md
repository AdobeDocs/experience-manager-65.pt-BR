...
O Designer está disponível como um instalador independente e também é fornecido com o WorkBench. Se você estiver usando um instalador independente para o AEM Forms Designer, execute as seguintes etapas:
...
Se você estiver usando um instalador independente para o AEM Forms Designer, execute as seguintes etapas:

1. Antes de instalar **AEM Forms Designer 6.5.16.0**, os usuários devem desinstalar qualquer versão anterior.
1. Baixe e instale [AEM Forms Designer 6.5.15.0](https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/forms-updates/aem-forms-releases.html) na página Versões do formulário AEM.
