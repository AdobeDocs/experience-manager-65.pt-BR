...
* **** Informações enviadas: Os seguintes campos listados abaixo servem como locais de saída para a tarefa:
   ...
   * **** Salvar anexos usando: Salve os anexos de formulário fornecidos em uma tarefa. É possível salvar os anexos usando um caminho relativo à carga ou armazená-lo em uma variável do tipo de dados Documento.
...
**Caminho** do formulário adaptável: Especifique o caminho do formulário adaptável. O campo está disponível quando você seleciona a opção Caminho **absoluto** Disponível no campo **Usar formulário** adaptável.
