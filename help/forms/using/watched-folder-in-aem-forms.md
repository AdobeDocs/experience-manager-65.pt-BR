...
1. Adicione as seguintes propriedades ao nó:
   ...
   * `inputProcessorId`
   * `outputFilePattern`
   Para obter uma lista completa das propriedades compatíveis, consulte Propriedades [da pasta](../../forms/using/watched-folder-in-aem-forms.md#main-pars-header-1)assistida.
