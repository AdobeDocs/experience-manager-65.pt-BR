...
# Usando o Serviço de Assembler{#using-assembler-service}
...
![Montagem de um documento PDF simples de vários documentos PDF](assets/as_document_assembly.png)

Montagem de um documento PDF simples de vários documentos PDF
...
O uso do DDX e do serviço Assembler para chamar outros serviços do LiveC ycle pode simplificar o diagrama do processo. Ele pode até reduzir o esforço que você gasta personalizando seus workflows. (Consulte também
