...
1. Na página do Publish, selecione **[!UICONTROL Todas as configurações]** e selecione **[!UICONTROL Publish]**. Publish: configurações de nuvem do Power Automate Dataverse e do Power Automate Flow Service.
