...
Formulários adaptáveis são formulários de nova geração que são dinâmicos e responsivos. Você pode usar os formulários adaptativos para fornecer experiências personalizadas. Você também pode integrar formulários adaptáveis com [!DNL Adobe Analytics] para estatísticas de uso e [!DNL Adobe Campaign] para gestão de campanha. Para obter mais informações sobre recursos de formulários adaptáveis, consulte [Introdução à criação de formulários adaptáveis](/help/forms/using/introduction-forms-authoring.md).
...
1. Faça logon na instância do autor AEM e navegue até **[!UICONTROL Adobe Experience Manager]** > **[!UICONTROL Forms]** > **[!UICONTROL Forms &amp; Documentos]**. O URL padrão é [http://localhost:4502/aem/forms.html/content/dam/formsanddocuments](http://localhost:4502/aem/forms.html/content/dam/formsanddocuments).
...
1. Uma opção para **[!UICONTROL Adicionar propriedades]** é exibida. Os campos **[!UICONTROL Title]** e **[!UICONTROL Nome]** são obrigatórios:

   * **Título:** Especifique  `Add new or update shipping address` no  **** campo Título. O campo de título especifica o nome de exibição do formulário. O título ajuda a identificar o formulário na interface do usuário AEM [!DNL Forms].
...
1. Toque em ![painel lateral de alternância](assets/toggle-side-panel.png) > ![treeexpandall](assets/treeexpandall.png). O navegador de componentes é aberto. Arraste o componente **[!UICONTROL Cabeçalho]** do navegador de componentes para o formulário adaptável.
...
1. Toque em Imagem. A barra de ferramentas é exibida. Toque em ![cmppr](assets/cmppr.png). O navegador de propriedades é aberto à esquerda da tela. **[!UICONTROL Navegue]** e faça upload da imagem do logotipo. Toque em ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png). A imagem é exibida no cabeçalho.
...
1. Arraste um componente **[!UICONTROL Caixa numérica]** antes do componente de rodapé. Abra as propriedades do componente, defina os valores listados na tabela abaixo, Toque em ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
...
1. Arraste um componente **[!UICONTROL Email]** antes do componente de rodapé. Abra as propriedades do componente, defina os valores listados na tabela abaixo e toque em ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
...
1. Arraste um componente **[!UICONTROL Anexo de arquivo]** antes do componente de rodapé. Abra as propriedades do componente, defina os valores listados na tabela abaixo e toque em ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
...
1. Toque em **[!UICONTROL Container de formulário]** no navegador de conteúdo e toque em ![cmppr](assets/cmppr.png). O navegador de propriedades é aberto à esquerda.
1. Vá para **[!UICONTROL Enviar]** > **[!UICONTROL Enviar Ação]**. Selecione **[!UICONTROL Enviar email]**. Especifique os seguintes valores e toque em ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
   ...
   Seu formulário está pronto. Agora, você pode pré-visualização o formulário e testar a funcionalidade. Se você tiver usado o nome mencionado no tutorial e acessado o formulário no computador que executa o servidor AEM [!DNL Forms], o formulário estará disponível em [http://localhost:4502/editor.html/content/forms/af/shipping-address-add-update-form.html](http://localhost:4502/editor.html/content/forms/af/shipping-address-add-update-form.html).

## Etapa 5: Pré-visualização e envie o formulário adaptativo {#step-preview-and-submit-the-adaptive-form}

Você pode usar a opção **[!UICONTROL Pré-visualização]** para avaliar a aparência e o comportamento de um formulário. É possível enviar um formulário no modo de pré-visualização e também verificar as validações aplicadas a um formulário. Por exemplo, se um erro for exibido quando um campo obrigatório for deixado em branco.

Formulários adaptáveis também oferecem uma opção para emular a experiência de um formulário para vários dispositivos. Por exemplo, iPhone, iPad e Desktop. Você pode usar as opções **[!UICONTROL Pré-visualização]** e **[!UICONTROL Emulador]** ![régua](assets/ruler.png) em conjunto para pré-visualização de um formulário para dispositivos de tamanhos de tela diferentes.
