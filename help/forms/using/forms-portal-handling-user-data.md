...
description: Portal da Forms | Tratamento de dados de utilizadores
...
* Para ações de envio diferentes de **Ação de envio do Forms Portal**, a opção **[!UICONTROL Armazenar dados no portal de formulários]** está ativada nas propriedades **[!UICONTROL Submission]** do container de formulário adaptável.
