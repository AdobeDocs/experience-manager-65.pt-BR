...
A interface do AEM usuário é otimizada para telas maiores (normalmente notebooks e computadores desktop) e fator de formulário de tablet (como Apple iPad ou Microsoft® Surface). O fator de forma do telefone não é compatível.
...
## Observações de Platform adicionais {#additional-platform-notes}
...
>[!NOTE]
>
Esses requisitos **do sistema se aplicam somente** se você usar Mídia dinâmica - modo híbrido; Mídia dinâmica - O modo Híbrido tem um servidor de imagem incorporado, que é certificado apenas em determinados sistemas operacionais.
>
Para Mídia dinâmica clientes que executam Mídia dinâmica - Scene7 modo (ou seja, **dynamicmedia_scene7** modo de execução), não há requisitos adicionais do sistema; apenas os mesmos requisitos do sistema que os AEM. Dynamic Media - A arquitetura de modo Scene7 usa o serviço de imagem baseado em nuvem e não o serviço incorporado no AEM.
...
* Uma versão do Acrobat é fornecida com o AEM Forms para ativar a funcionalidade PDF Generator. Acesse programaticamente a versão empacotada somente com AEM Forms, durante o período da licença de AEM Forms, para uso com AEM Forms O Gerador de PDF. Para obter mais informações, consulte AEM Forms descrição do produto de acordo com as implantação ([No local](https://helpx.adobe.com/legal/product-descriptions/adobe-experience-manager-on-premise.html) ou [Managed Services](https://helpx.adobe.com/legal/product-descriptions/adobe-experience-manager-managed-services.html))
