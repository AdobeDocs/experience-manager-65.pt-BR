---
title: Reestruturação comum dos repositórios no AEM 6.5
seo-title: Reestruturação comum dos repositórios no AEM 6.5
...
* [Endpoint JavaScript do Adobe DTM](/help/sites-deploying/all-repository-restructuring-in-aem-6-5.md#adobe-dtm-javascript-endpoint)
* [Endpoint de gancho na Web do Adobe DTM](/help/sites-deploying/all-repository-restructuring-in-aem-6-5.md#adobe-dtm-web-hook-endpoint)
...
* [AEM Projetos Configurações de Gadget de Painéis](/help/sites-deploying/all-repository-restructuring-in-aem-6-5.md#aem-projects-dashboard-gadget-configurations)
 ...
 <tbody>
  ...
  <tr>
   ...
   <td><p>Todos os modelos de fluxo de trabalho novos ou modificados devem ser migrados para /conf/global/workflow/models.</p>
    <ol>
     <li>Implante os Modelos de fluxo de trabalho modificados em uma instância de desenvolvimento local AEM 6.5, de modo que eles existam no local Anterior.</li>
