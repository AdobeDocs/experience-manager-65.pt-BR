...
+ Reestruturação do repositório {#restructuring}
   ...
   + [Reestruturação do repositório do Sites no AEM 6.5](sites-repository-restructuring-in-aem-6-5.md)
   ...
   + [Reestruturação do repositório para AEM Communities no ponto 6.5](communities-repository-restructuring-in-aem-6-5.md)
+ eCommerce {#ecommerce}
