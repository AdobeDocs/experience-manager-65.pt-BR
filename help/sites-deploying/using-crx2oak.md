...
A lista de alterações e correções para a versão mais recente pode ser encontrada no [Notas de versão do CRX2Oak](https://experienceleague.adobe.com/docs/experience-manager-64/release-notes/crx2oak.html).
