...
A lista de alterações e correções para a versão mais recente pode ser encontrada no [Notas de versão do CRX2Oak](https://docs.adobe.com/content/help/en/experience-manager-64/release-notes/crx2oak.html).
