...
As configurações do ContextHub são efetuadas por uma atualização. Instruções sobre como recuperar as configurações existentes do ContextHub podem ser encontradas [aqui](/help/sites-administering/contexthub-config.md#recover contexthub settings after upgrade).
