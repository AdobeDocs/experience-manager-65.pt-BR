...
Portanto, várias configurações devem ser movidas para não residirem mais em `/etc`, como acontecia no passado. Para analisar o conjunto completo de problemas de reestruturação de repositório que devem ser revisados e acomodados na atualização para o AEM 6.4, consulte [Reestruturação de repositório no AEM 6.4](/help/sites-deploying/repository-restructuring.md).
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td>Qualquer mecanismo de autenticação, como LDAP/SAML, deve ser validado.<br /> As permissões e os grupos devem ser testados nos níveis Autor e Publicação<br />.</td>
  </tr>
  <tr>
   <td>Consultas</td>
