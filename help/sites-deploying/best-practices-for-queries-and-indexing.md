...
>[!NOTE]
>
>No AEM 6.5, [oak-run.jar é o ÚNICO método](/help/sites-deploying/indexing-via-the-oak-run-jar.md#reindexingapproachdecisiontree) compatível para reindexação em repositórios MongoMK ou RDBMK.
