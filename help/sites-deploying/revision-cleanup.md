...
**O AEM 6.5** apresenta **dois novos modos** para a fase de **compactação** do processo de Limpeza de revisão online:
...
O AEM 6.5 também apresenta um mecanismo mais eficiente de desduplicação de conteúdo durante a compactação, o que reduz ainda mais o espaço ocupado no disco do repositório.

Os dois gráficos a seguir apresentam resultados de testes laboratoriais internos que ilustram a redução do tempo médio de execução e do espaço médio no disco no AEM 6.5 em comparação com o AEM 6.3:
...
### Considerações sobre atualização do AEM 6.5 {#aem-upgrade-considerations}
