...
>[!CAUTION]
>
>Use uma versão de ferramenta Oak-run que tenha um número de versão (principal e secundário) que corresponda à versão principal do Oak de sua instalação do AEM. Por exemplo, se sua instância de AEM tiver o Oak core versão 1.22.x, você deverá usar a versão mais recente da ferramenta Oak-run 1.22.x.
