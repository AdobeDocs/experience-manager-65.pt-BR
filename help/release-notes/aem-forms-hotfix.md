...
<table>
  ...
  <tr>
    ...
    <td>
    <ul>
    <li>(GRANITE-63681) Os conectores do modelo de dados de formulário podem não ser autenticados porque as palavras-chave e o padrão regex necessários não são permitidos por padrão.</li>
    </ul>
    </td>
  </tr>
    <tr>
