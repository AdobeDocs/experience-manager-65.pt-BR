...
| Data | Thursday, February 23, 2023 <!-- UPDATE FOR EACH NEW RELEASE --> |
...
* Remove Adobe Search&amp;Promote code and dependency from Experience Manager 6.5. Adobe Search&amp;Promote reached end-of-service September 2022. See [Adobe Search&amp;Promote End-of-Service Announcement](https://experienceleague.adobe.com/docs/discontinued/using/search-promote.html?lang=pt-BR). (NPR-39706)
...
* Unable to print a content fragment&#39;s JSON. O motivo é que a consulta do GraphQL não pode ser gerada ao abrir a página Visualizar do fragmento de conteúdo. (SITES-8619)
