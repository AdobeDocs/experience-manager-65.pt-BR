...
* Caso altere a senha padrão do usuário administrador de `admin`, enquanto executa a `Prepare Adobe Experience Manager Server For DSC deployment` falha ao verificar o service pack do AEM Forms JEE. (NPR-40062) e (NPR-39387)
...
* Remova o Search &amp; Promote de Adobe e a dependência do Experience Manager 6.5. O Adobe Search &amp; Promote chegou ao fim do serviço em setembro de 2022. Consulte [Anúncio de fim de serviço do Adobe Search &amp; Promote](https://experienceleague.adobe.com/docs/discontinued/using/search-promote.html). (NPR-39706)
...
* Criar um projeto de tradução exibe o erro *O recurso de página mestra não existe*; o projeto de tradução não é criado. (NPR-39762)
