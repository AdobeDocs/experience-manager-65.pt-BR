...
* O AEM Forms no JEE agora é compatível com o Apache Geode como solução de cache.
...
* Entrada [!DNL Dynamic Media], na interface para criar um perfil de codificação de vídeo, a variável [!UICONTROL Smart Crop Ratio] for rotulada como acessibilidade para que os leitores de tela a anunciem adequadamente.
...
* Se houver um workflow de contêiner incorporado, você receberá vários emails de conclusão do workflow mesmo depois de selecionar a variável `Notify on Complete of Container Workflow` (NPR-37280).
...
* [Experience Manager Screens: Pacote de recursos 202109](https://experienceleague.adobe.com/docs/experience-manager-screens/user-guide/release-notes/release-notes-fp-202109.html)
