...
* O Reader de tela não lê os dados de campo flutuante colocados dentro do rótulo de texto na página Principal ou nas páginas Subformulário em um PDF dinâmico (CQ-4321587).
