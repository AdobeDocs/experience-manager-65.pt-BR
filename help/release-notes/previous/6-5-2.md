...
* Problema de conectividade com as tags inteligentes da Adobe por meio do Datapower. NPR-30026: Hotfix do CQ-4269457
...
* A configuração do [!DNL Dynamic Media] Cloud Services no modo [!DNL Dynamic Media]-Híbrido resulta em vários conjuntos de relatórios vazios criados em [!DNL Analytics], e sem nenhuma ID de conjunto de relatórios armazenada em [!DNL Experience Manager], resultando na duplicação do conjunto de relatórios. Hotfix do CQ-4249780
* Falha ao sincronizar a operação de renomeação do ativo [!DNL Experience Manager] com o nome duplicado para Scene7. Hotfix do CQ-4276763
* O conteúdo gerado pelo usuário é exibido incorretamente no painel de filtro de pesquisa. Hotfix do CQ-4273875
* A opção &quot;Localizar semelhante&quot; não está disponível para imagens do TIFF. Hotfix do CQ-4278238
...
* 3.8 Os arquivos README dos visualizadores do SDK e 5.13 não são atualizados e contêm informações de versões anteriores. Hotfix do CQ-4273737
...
* A instância atualizada de 6.3.3.2 para 6.5 está resultando em configurações OSGi duplicadas. NPR-30130: Hotfix do CQ-4274016
...
Os principais destaques para [!DNL Experience Manager] formulários de 6.5.2.0 são:
...
O UberJar para Experience Manager 6.5.2.0 está disponível no [repositório central Maven](https://repo.maven.apache.org/maven2/com/adobe/aem/uber-jar/6.5.2/).
