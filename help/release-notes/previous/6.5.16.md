...
* Uma consulta do GraphQL pode usar o `damAssetLucene` índice em vez de `fragments` índice. Dessa forma, pode resultar em falhas em consultas do GraphQL ou levar muito tempo para executar.
...
* Na plataforma JBoss® 7.1.4, quando um usuário instala o pacote de serviços AEM 6.5.16.0, `adobe-livecycle-jboss.ear` falha na implantação.
