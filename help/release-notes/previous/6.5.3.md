...
* O menu suspenso Criar, que é visível no menu superior ao selecionar uma pasta, não mostra &quot;Pasta&quot; como uma opção de criação (NPR-30877).
...
* A geração da visualização HTML5 de um formulário XDP exibe uma cintilação ao adicionar instâncias de um subformulário (NPR-30909).
