...
* Quando um usuário converte um arquivo XTG no formato PostScript usando o Serviço de Saída, ele falha com o erro: `(AEM_OUT_001_003:Unexpected Exception: PAExecute Failure: XFA_RENDER_FAILURE)`. (LC-3921720)
...
>[!IMPORTANT]
>
> A Adobe não recomenda que você remova ou desinstale o pacote [!DNL Experience Manager] 6.5.21.0. Dessa forma, antes de instalar o pacote, você deve criar um backup do `crx-repository`, caso precise revertê-lo. <!-- UPDATE FOR EACH NEW RELEASE -->
...
>[!NOTE]
>
>O Experience Manager 6.5.21.0 não oferece suporte à instalação do Bootstrap. <!-- UPDATE FOR EACH NEW RELEASE -->
...
O UberJar para [!DNL Experience Manager] 6.5.21.0 está disponível no [repositório central Maven](https://repo.maven.apache.org/maven2/com/adobe/aem/uber-jar/6.5.21/). <!-- CHECK FOR UPDATE EACH NEW RELEASE -->
...
* SITES-17934 - Fragmentos de conteúdo - A visualização falha devido à proteção DoS para fragmentos de árvore grandes. Consulte o artigo de [KB sobre as opções de configuração do Executor de Consulta Padrão do GraphQL](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-23945)
...
* [Lista de pacotes OSGi incluídos no Experience Manager 6.5.21.0](/help/release-notes/assets/65210-bundles.zip) <!-- UPDATE FOR EACH NEW RELEASE -->
* [Lista de Pacotes de Conteúdo incluídos no Experience Manager 6.5.21.0](/help/release-notes/assets/65210-packages.zip) <!-- UPDATE FOR EACH NEW RELEASE -->
