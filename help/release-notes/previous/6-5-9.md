...
>O suporte para os JDKs [!DNL Azul Zulu] também é fornecido pela Adobe aos clientes [!DNL Experience Manager].
>Você pode baixar as versões relevantes dos JDKs [!DNL Azul Zulu] na [Distribuição de software da Adobe](https://experience.adobe.com/#/downloads/content/software-distribution/br/aem.html).
...
Em [!DNL Adobe Experience Manager] 6.5.9.0, os seguintes aprimoramentos de acessibilidade estão disponíveis em [!DNL Dynamic Media]:
...
* A opção [!UICONTROL Publicar no Dynamic Media] não está disponível nas opções [!UICONTROL Publicação rápida] da página [!UICONTROL Propriedades] (CQ-4317199).
...
><!-- CQDOC-18116 -->* Não é possível transmitir vídeos no Experience Manager - Dynamic Media em execução no modo híbrido.
...
* Não é possível salvar propriedades de página com herança habilitada para Fragmentos de experiência de serviços em nuvem (NPR-36107).
...
* Na filtragem de spam, o sistema consome 100% do espaço do heap do Java™, tornando o servidor do Experience Manager sem resposta (NPR-36316, NPR-36493).
...
O UberJar para Experience Manager 6.5.9.0 está disponível no [repositório central Maven](https://repo.maven.apache.org/maven2/com/adobe/aem/uber-jar/6.5.9/).
