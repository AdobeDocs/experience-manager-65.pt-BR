...
* **Transmissão DASH com Dynamic Media** - O suporte ao novo protocolo (DASH - Dynamic Adaptive Streaming por HTTP) foi iniciado para a transmissão Adaptive na entrega de vídeo do Dynamic Media (com CMAF habilitado).
