...
* In some instances of AEM, the version preview and comparison functionalities were not working as expected across several pages. Especificamente:
...
* A template&#39;s &quot;Published&quot; timestamp was not updating in the author environment, even though the template was successfully replicated to the publish instances. O comportamento esperado era que o carimbo de data e hora na instância do autor refletisse a publicação mais recente, mas essa atualização não estava ocorrendo conforme o esperado. (SITES-21585)
