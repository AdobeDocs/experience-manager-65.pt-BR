...
* [Lista de pacotes OSGi incluídos no Experience Manager 6.5.22.0](/help/release-notes/assets/65220-bundles.zip) <!-- UPDATE FOR EACH NEW RELEASE -->
* [Lista de Pacotes de Conteúdo incluídos no Experience Manager 6.5.22.0](/help/release-notes/assets/65220-packages.zip) <!-- UPDATE FOR EACH NEW RELEASE -->
