...
Alguns dos principais recursos e melhorias são:

* **[Suporte para Acessibilidade de Lista no AEM Forms Designer](https://helpx.adobe.com/content/dam/help/pt-br/experience-manager/6-5/forms/pdf/using-designer.pdf)**: o AEM Forms Designer agora permite que os autores criem estruturas de Lista acessíveis, atribuindo funções de Lista, Item de Lista e Rótulo de Lista a subformulários por meio da Guia Acessibilidade. O recurso oferece suporte a listas simples, numeradas, com marcadores e aninhadas, com a geração adequada de tags do `<L>`, `<LI>`, `<Lbl>` e `<Lbody>` para compatibilidade com leitores de tela. Esse aprimoramento garante que as listas de formulários estejam em conformidade com os padrões de acessibilidade da PDF/UA, melhorando a navegação e a compreensão do conteúdo para os usuários de tecnologia assistiva.
