...
| -------- | ---------------------------- |
| Versão | 6.5.23.0, Hotfix for GRANITE-61551 <!-- UPDATE FOR EACH NEW RELEASE --> |
...
* **FORMS-16575**: qualquer modificação no XDP de fragmentos de layout aninhados em uma Comunicação Interativa não é refletida no editor IC.
...
* **FORMS-15681**:When a carta foi exibida na Visualização de Impressão, o conteúdo foi alterado. Ou seja, alguns espaços desaparecem e determinadas letras são substituídas por `x`.
