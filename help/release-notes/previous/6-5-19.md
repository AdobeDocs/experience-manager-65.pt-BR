...
* Quando um cliente salva um esquema de metadados com muitos campos, a solicitação multipart/form-data do formbuilder excede o limite maxFileCount, causando falhas silenciosas. (CQDOC-22465)
