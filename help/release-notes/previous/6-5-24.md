...
* Correção de baixo contraste na mensagem de status de bloqueio mostrada no fluxo de trabalho Bloquear/Desbloquear página. A mensagem agora atende a uma proporção 4.5:1, melhorando a legibilidade e a conformidade com a ADA para os autores. (SITES-27270)
...
## Pacotes da OSGi e pacotes de conteúdo inclusos {#osgi-bundles-content-packages}
...
* [Pacotes OSGi](/help/release-notes/assets/65240-bundles.zip)
* [Pacotes de conteúdo](/help/release-notes/assets/65240-packages.zip)
