...
* Os dados fornecidos pelo usuário não são escapados na saída no `cq/replication/components/agent` componente, resultando em uma vulnerabilidade de script entre sites (XSS). Hotfix do CQ-4266263
