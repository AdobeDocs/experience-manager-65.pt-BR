...
* O service pack do AEM Forms JEE 6.5.15.0 não está instalado corretamente no ambiente JBoss Linux. Valide a instalação correta do service pack do AEM Forms JEE 6.5.15.0 verificando o `PatchInstallerProcessing[1-9*].log` arquivo para a entrada de log, `[AEM_Forms_JEE_DIR]/patch/AEMForms-6.5.0-0057/xml/RUP_BOM.xml not found! Assuming this component isn't in the installation. Skipping Processing`.Esta entrada indica que a instalação do service pack do AEM Forms JEE 6.5.15.0 não foi bem-sucedida. Para corrigir o problema de instalação do service pack do AEM Forms JEE 6.5.15.0, manualmente [adicionar o arquivo RUP_BOM.xml](/help/forms/using/linux-jboss-installation-issue-on-sp15.md) para o diretório XML.
