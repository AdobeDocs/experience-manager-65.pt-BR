...
+++5. Instalar o fragmento do servlet (AEM Service Pack 6.5.14.0 ou anterior)
...
3. Abra os Pacotes de console da Web. O URL padrão é `http://[Server]:[Port]/system/console/bundles`.
...
+++6. Instalar o pacote de serviços AEM
