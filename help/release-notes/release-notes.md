...
* Adicionar uma lista de controle de acesso para `fd-cloudservice` para ler ou atualizar as configurações Microsoft® em `cloudconfigs/microsoftoffice`. (FORMS-11142)
