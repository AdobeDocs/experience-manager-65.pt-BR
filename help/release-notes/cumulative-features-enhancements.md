...
* O AEM Forms Designer agora está disponível em [localidade em espanhol](https://experienceleague.adobe.com/pt-br/docs/experience-manager-release-information/aem-release-updates/forms-updates/aem-forms-releases).
...
* Você pode definir a propriedade [Revalidar no servidor](https://experienceleague.adobe.com/pt-br/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-foundation-components/configure-submit-actions-and-metadata-submission/configuring-submit-actions#enabling-server-side-validation-br) como verdadeira para identificar os campos ocultos para exclusão de um Documento de Registro no lado do servidor.
