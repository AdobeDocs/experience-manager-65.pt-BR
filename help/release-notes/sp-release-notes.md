...
* Configuração do cliente HTTP do modelo de dados de formulário para otimizar o desempenho.

* Disponibilidade da opção Redefinir para cada componente no modo Layout
