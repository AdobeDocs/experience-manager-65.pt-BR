...
>[!NOTE]
>
>Uma versão atualizada do AEM 6.5 Service Pack 6 está disponível. Se você já tiver instalado uma versão anterior do Service Pack 6, atualize para a versão mais recente disponível.
