...
|---|---|---|---|
| [!DNL Sites] | Modelos de fragmento de conteúdo, para criar fragmentos de conteúdo simples. | [Fragmentos de conteúdo estruturado com base em modelo](/help/assets/content-fragments/content-fragments-models.md) agora. |  |
...
| Desenvolvedores | Usar a YUI para compactar/diminuir as bibliotecas do cliente do Javascript. A Adobe não planeja atualizar a biblioteca YUI. Até AEM 6.4, a YUI era padrão para diminuir o JavaScript com a opção de alternar para o Google Closure Compiler (GCC). Ao iniciar o AEM 6.5, o GCC é o padrão. | O Adobe recomenda que os clientes atualizem para o AEM 6.5 para alternar para o GCC para sua implementação |  |
...
| Área | Recurso | Substituição | Versão (SP) |
|--- |--- |--- |--- |
| Integração com [!DNL Experience Cloud] | Você pode sincronizar ativos com [!DNL Experience Cloud] usando uma configuração via [!DNL Adobe I/O]. [!DNL Adobe Experience Cloud] era anteriormente chamado [!DNL Adobe Marketing Cloud]. | Se você tiver alguma query, [entre em contato com o Suporte ao cliente Adobe](https://www.adobe.com/account/sign-in.supportportal.html). |  |
