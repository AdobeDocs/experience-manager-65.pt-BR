...
|---|---|---|---|
| Sites | [Editor de SPA](/help/sites-developing/spa-editor-deprecation.md) | Para casos de uso headless, utilize o [Editor universal](/help/sites-developing/universal-editor/introduction.md) para edição visual ou o [Editor de fragmentos de conteúdo](/help/sites-developing/universal-editor/introduction.md) para edição baseada em formulário. | 6.5.23 |
