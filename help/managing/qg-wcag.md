...
O Adobe Experience Manager (AEM) foi desenvolvido para maximizar a conformidade com as Diretrizes de acessibilidade do conteúdo da Web.
...
* Os critérios de sucesso podem incluir opções ou exceções; situações em que os critérios de sucesso não precisam ser cumpridos.`True``False`
* Os critérios de sucesso são numerados de acordo com a diretriz e o princípio principais, de 1.1.1 a 4.1.1. Eles também têm um nome curto que resume a intenção do critério, para uma referência mais fácil. Por exemplo, o critério de sucesso [1.1.1 é Conteúdo não textual[#$tu42].
* 
* Recursos de suporte {#supporting-resources}**

## Além dos componentes principais de Princípios, Diretrizes e Critérios de sucesso da WCAG 2.1, existe uma série de documentos de suporte. Alguns deles fornecem conselhos específicos sobre como cumprir os aspectos das diretrizes, outros são referências mais gerais que ajudam os autores, designers e desenvolvedores da Web de todas as habilidades a entender e usar a WCAG 2.1 da forma mais eficaz possível.{#supporting-resources}
...
### Esta lista não está completa. Ela apresenta os recursos disponíveis:{#wcag-resources}

[Um definição de todos os documentos relacionados à WCAG[#$tu50]
* 
* 
* 
* 
...
### As diretrizes fornecem informações sobre as novidades da WCAG 2.1:{#what-is-new}

O documento [Novidades da WCAG 2.1[#$tu64] fornece informações importantes sobre o delta entre a WCAG 2.0 e a WCAG 2.1.

* 

* 

### As técnicas da WCAG 2.1 estão disponíveis na página [Técnicas da WCAG 2.1[#$tu69] .
...
* Cada técnica tem um número exclusivo, que está relacionado à coleção. Por exemplo, uma das técnicas ARIA é a [Técnica ARIA2: identificação de um campo obrigatório com a propriedade &quot;aria-required&quot;[#$tu76].
...
### Trata-se de uma série de documentos que fornecem conselhos para ajudar os leitores a compreender o objetivo de diretrizes e critérios de sucesso específicos. Você pode [baixar uma introdução, além de links para informações mais detalhadas[#$tu85].
