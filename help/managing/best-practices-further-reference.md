...
Além disso, verifique as [Notas de versão](/help/release-notes/release-notes.md), para ver as várias versões do AEM, para ver quando novos recursos foram adicionados.
