...
# Banners de carrossel{#carousel-banners}
...
1. Opcional: [Crie uma predefinição](/help/assets/managing-viewer-presets.md)do visualizador Conjunto de carrossel, conforme necessário.
...
1. [Criar um conjunto](#creating-carousel-sets)de carrossel.
   ...
   Para criar um Conjunto de carrossel em Ativos, toque em **[!UICONTROL Criar]** e selecione Conjuntos **[!UICONTROL de]** carrossel. Adicione ativos a slides e toque em **[!UICONTROL Salvar]**. Você também pode editar a aparência e o comportamento do carrossel diretamente no editor.
...
1. Faça uma das seguintes opções:
   ...
   * [Adicionar um banner de carrossel ao seu site no AEM
      ](/help/assets/adding-dynamic-media-assets-to-pages.md)Se você for um cliente do AEM Sites, poderá adicionar o carrossel definido diretamente à página no AEM, usando o componente de Mídia interativa.


Se precisar editar Conjuntos de carrossel, consulte [edição de Conjuntos de carrossel.](#editing-carousel-sets) Além disso, você pode exibir e editar as propriedades [do Conjunto de](https://helpx.adobe.com/experience-manager/6-5/help/assets/managing-assets-touch-ui.md#editingproperties)carrossel.
...
1. Na página Editor de banner do carrossel, toque em **[!UICONTROL Tocar para abrir o Seletor]** de ativos para selecionar a imagem para o primeiro slide.
   ...
   * Próximo ao meio da página, toque em **[!UICONTROL Tocar para abrir o Seletor]** de ativos.
   Toque em para selecionar os ativos que deseja incluir no Conjunto de carrossel. Os ativos selecionados têm um ícone de marca de seleção sobre eles. Quando terminar, próximo ao canto superior direito da página, toque em **[!UICONTROL Select**.

   Com o Seletor de ativos, você pode procurar ativos digitando uma palavra-chave e tocando ou clicando em **[!UICONTROL Retornar]**. Você também pode aplicar filtros para refinar os resultados da pesquisa. Você pode filtrar por caminho, coleção, tipo de arquivo e tag. Selecione o filtro e toque no ícone **[!UICONTROL Filtro]** na barra de ferramentas. Altere a exibição tocando no ícone Exibir e selecionando Exibição **[!UICONTROL de]** coluna, Exibição **[!UICONTROL de]** cartão ou Exibição **[!UICONTROL de]** lista.
...
1. (Opcional) Execute um dos procedimentos a seguir:
   ...
   * Se necessário, arraste o slide para reordenar as imagens na lista de conjuntos.
...
Quando terminar de criar o banner do carrossel, você pode usar a opção Visualizar para ver uma representação de como o banner do carrossel será exibido aos clientes.
...
1. Próximo ao canto superior esquerdo da página, toque em **[!UICONTROL Ponto de acesso]** ou Mapa **** de imagem.
...
1. Execute um dos procedimentos a seguir na guia **[!UICONTROL Ações]** :
   ...
   * Toque em **[!UICONTROL Quickview]**.
      ...
      * Se você for um cliente do AEM Sites e do Ecommerce, toque no ícone do Seletor de produtos (lupa) para abrir a página Selecionar produto. Toque no produto que deseja usar e, em seguida, toque na marca de seleção no canto superior direito da página para retornar ao Editor de banner do carrossel.
   ...
   * Toque em Fragmento **[!UICONTROL de experiência]**.
...
1. Para editar o Conjunto de carrossel, execute um dos procedimentos a seguir:
   ...
   * Para aplicar uma predefinição, próximo ao canto superior direito da página, toque na lista suspensa **[!UICONTROL Predefinir]** e selecione uma predefinição do visualizador.
...
Você pode usar a opção Visualizar para ver como será a aparência do seu banner de carrossel para os clientes e testar os pontos de conexão e mapas de imagem dos banners de carrossel para garantir que eles estejam se comportando como esperado.

Quando estiver satisfeito com o banner do carrossel, você poderá publicá-lo.
Consulte [Incorporação do visualizador de vídeo ou imagem em uma página](/help/assets/embed-code.md)da Web.
...
1. Em **[!UICONTROL Ativos]**, navegue até um banner de carrossel existente que você criou e toque para abri-lo.
1. Ao lado do canto superior esquerdo da página Visualização, clique no ícone Conteúdo.
...
A última etapa desse processo é integrar o banner do carrossel com uma implementação de visualização rápida existente em seu site. Toda implementação de visualização rápida é única e é necessária uma abordagem específica que provavelmente envolva a assistência de uma pessoa de TI de front-end.
...
Consulte [Uso de exibições rápidas para criar pop-ups](/help/assets/custom-pop-ups.md)personalizados.
