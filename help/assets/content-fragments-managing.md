...
seo-title: Gerenciamento de fragmentos de conteúdo
...
[Os modelos](/help/assets/content-fragments-models.md) de fragmento de conteúdo podem ser ativados e criados antes da criação de fragmentos de conteúdo com conteúdo estruturado.
...
1. A primeira etapa do assistente requer que você especifique a base do novo fragmento.
   ...
   * Isso pode ser:
      ...
      * [Modelo](/help/assets/content-fragments-models.md) - usado para criar um fragmento que requer conteúdo estruturado; por exemplo, o modelo de **aeroporto**
...
1. Selecione **Criar** para concluir a ação e, em seguida, **Abrir** o fragmento para edição ou retornar ao console com **Concluído**.
...
* **Editar**
   ...
   * Permite [abrir o fragmento para edição de conteúdo](/help/assets/content-fragments-variations.md) junto com seus elementos, variações, conteúdo associado e metadados.

* **Gerenciar tags**
* **Para a coleção**

   * Adicione o fragmento a uma coleção.
   * Isso também pode ser feito ao [associar uma coleção ao fragmento](/help/assets/content-fragments-assoc-content.md#adding-associated-content).
...
1. Depois de fazer alterações, use **Salvar** ou **Cancelar** , conforme necessário.
...
>[!NOTE]
>
>As versões também podem ser [criadas, comparadas e revertidas na Linha do tempo](/help/assets/content-fragments-managing.md#timeline-for-content-fragments).
...
Após abrir o fragmento, use a guia [Variações](/help/assets/content-fragments-variations.md) para criar o conteúdo.

## Criação e gerenciamento de variações no fragmento {#creating-and-managing-variations-within-your-fragment}

Depois de criar o conteúdo mestre, você pode criar e gerenciar [variações](/help/assets/content-fragments-variations.md) desse conteúdo.

## Associar conteúdo ao fragmento {#associating-content-with-your-fragment}

Também é possível [associar conteúdo](/help/assets/content-fragments-assoc-content.md) a um fragmento. Isso fornece uma conexão para que os ativos (ou seja, imagens) possam ser usados (opcionalmente) com o fragmento quando ele for adicionado a uma página de conteúdo.
...
É possível exibir e editar as propriedades de um fragmento usando a guia [Metadados](/help/assets/content-fragments-metadata.md) .
...
A ação **Comparar com o atual** está disponível na [Linha](/help/assets/content-fragments-managing.md#timeline-for-content-fragments) do tempo depois que você seleciona uma versão específica.
...
* Diretamente da [Linha do tempo](/help/assets/content-fragments-managing.md#timeline-for-content-fragments).

   Selecione a versão necessária e, em seguida, a ação **Reverter para esta versão** .

* Ao [comparar uma versão com a versão](/help/assets/content-fragments-managing.md#comparing-fragment-versions) atual, é possível **Reverter** para a versão selecionada.

## Publicação e referência de um fragmento {#publishing-and-referencing-a-fragment}

>[!CAUTION]
>
>Se o fragmento for baseado em um modelo, verifique se o [modelo foi publicado](/help/assets/content-fragments-models.md#publishing-a-content-fragment-model).
>
