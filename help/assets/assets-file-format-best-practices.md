...
Para obter o desempenho ideal, o Adobe recomenda usar a [!DNL Adobe Camera Raw] biblioteca para arquivos RAW e DNG.
...
Para obter mais informações, consulte suporte [](/help/assets/camera-raw.md)Camera Raw.
...
O Adobe recomenda usar [!DNL Adobe InDesign Server] para extrair execuções [!DNL Adobe InDesign]específicas, como IDML e HTML. Para obter mais informações, consulte [Adicionar ativos Experience Manager como referências no Adobe InDesign](/help/assets/managing-linked-subassets.md#refai).
