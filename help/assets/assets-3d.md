...
O Dynamic Media suporta os seguintes formatos 3D.
...
Antes de trabalhar com ativos 3D no Dynamic Media, verifique se o administrador do AEM já habilitou e configurou os Cloud Services do Dynamic Media no modo Scene7.
...
1. Perto do canto superior direito da página, na lista suspensa **[!UICONTROL Visualização]**, toque em **[!UICONTROL Visualização do cartão.]**
...
Um ativo 3D totalmente interativo, conforme exibido em    ![Ativo 3D exibido dentro do ](/help/assets/assets-dm/3d-asset-in-3d-media.png)
...
1. Na seção **[!UICONTROL Propriedades]**, na guia **[!UICONTROL Componentes permitidos]**, vá até **[!UICONTROL Mídia dinâmica]**, expanda a lista e marque **[!UICONTROL Mídia 3D.]**
1. Toque em **[!UICONTROL Concluído]** para guardar as alterações e fechar o **[!UICONTROL Editor de Políticas.]**
...
Consulte também [Adicionar ativos de Mídia Dinâmica às páginas.](/help/assets/adding-dynamic-media-assets-to-pages.md)
...
Consulte também [Publicar ativos de Mídia Dinâmica.](publishing-dynamicmedia-assets.md)

Consulte também [Páginas de publicação.](/help/sites-authoring/publishing-pages.md)
...
* **[!UICONTROL Incorporar]**  - Use  **** Incorporar quando quiser visualização um ativo 3D do Dynamic Media incorporado em uma página da Web usando o visualizador Dimensional. Copie o código incorporado na área de transferência para poder colá-lo nuas páginas da Web. A edição do código não é permitida na caixa de diálogo **[!UICONTROL Embed]**.
   ...
   Consulte [Incorporação do Vídeo de Mídia Dinâmica, do Visualizador de Imagens ou do Visualizador Dimensional em uma página da Web.](/help/assets/embed-code.md#embedding-the-video-or-image-viewer-on-a-web-page)