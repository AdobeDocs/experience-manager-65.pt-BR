...
| *Nenhum URL inserido para ser invalidado.* | Ocorre se não houver URLs presentes na página Invalidação **[!UICONTROL do]** CDN - **[!UICONTROL Confirmar]** e você tocar em **[!UICONTROL Enviar.]** |
