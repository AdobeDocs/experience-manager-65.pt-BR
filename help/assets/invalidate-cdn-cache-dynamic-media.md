...
1. No AEM 6.5.6 ou posterior, toque em **[!UICONTROL Ferramentas > Ativos > Invalidação CDN.]**
...
1. Na página **[!UICONTROL Invalidação CDN - Confirmar]**, na caixa de lista **[!UICONTROL URLs]**, você verá uma lista de um ou mais URLs gerados a partir do Modelo de Invalidação CDN criado anteriormente e dos ativos que você acabou de adicionar.
