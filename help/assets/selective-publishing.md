...
Independentemente de você depender do valor **[!UICONTROL Publicar ativos]** definido em **[!UICONTROL Configuração do Dynamic Media]** ou do valor **[!UICONTROL Modo de publicação do Dynamic Media]** definido nas propriedades no nível da pasta, você pode escolher **[!UICONTROL Imediatamente]**, **[!UICONTROL Após a ativação]** ou **[!UICONTROL Publicação seletiva]**. Por exemplo, você pode definir o valor **[!UICONTROL Publicar ativos]** em sua **[!UICONTROL Configuração do Dynamic Media]** como **[!UICONTROL Na ativação]**, mas definir o valor do modo **[!UICONTROL Dynamic Media Publish]** no nível da pasta como **[!UICONTROL Publicação seletiva]**, e vice-versa.
...
1. Na barra de ferramentas, toque em **[!UICONTROL Gerenciar publicação]**. Toque no ícone de reticências na barra de ferramentas para abrir **[!UICONTROL Gerenciar publicação]**.
