...
Uma coleção é um conjunto de ativos em [!DNL Adobe Experience Manager Assets]. Use coleções para compartilhar ativos entre usuários. O conjunto pode ser uma coleção estática ou dinâmica baseada em resultados de pesquisa.
...
1. Arraste os ativos para a zona **[!UICONTROL Soltar na coleção]**. Como alternativa, clique em **[!UICONTROL Para coleção]** na barra de ferramentas.
...
1. Navegue até a interface do usuário [!DNL Assets] e clique em pesquisar.
...
1. Especifique um nome para a coleção. Selecione **[!UICONTROL Public]** para adicionar o grupo Usuários do DAM com a função Visualizador à coleção inteligente.
   ...
   >[!NOTE]
   >
   >Se você selecionar **[!UICONTROL Público]**, a coleção inteligente ficará disponível para todos com a função de proprietário depois de criá-la. Se você cancelar a opção **[!UICONTROL Public]**, o grupo de usuários do DAM não será mais associado à coleção inteligente.

1. Clique em **[!UICONTROL Save]** para criar a coleção inteligente e feche a caixa de mensagem para concluir o processo.
...
1. Na interface do usuário do [!DNL A]Assets, selecione o ativo e clique em **[!UICONTROL To Collection]** ![add to collection](assets/do-not-localize/add-to-collection.png) na barra de ferramentas.
...
1. Na caixa de diálogo de confirmação, clique em **[!UICONTROL Save]** para concluir o processo.
...
1. No console [!UICONTROL Collections], selecione uma coleção e clique em **[!UICONTROL Properties]** na barra de ferramentas.
...
1. Para exibir as propriedades de metadados de uma coleção específica, cancele a seleção das coleções restantes na lista de coleções. Os campos do editor de metadados são preenchidos com os metadados para a coleção específica.
   ...
   >[!NOTE]
   >
   >* Na página [!UICONTROL Properties], é possível remover coleções da lista de coleções cancelando a seleção. A lista de coleções tem todas as coleções selecionadas por padrão. [!DNL Experience Manager] não atualiza os metadados das coleções removidas.
...
>[!TIP]
>
>O método de edição em massa funciona para ativos disponíveis em uma coleção. Para os ativos que estão disponíveis em pastas ou que correspondem a critérios comuns, é possível [atualizar os metadados em massa após pesquisar](/help/assets/search-assets.md#metadataupdates).

## Pesquisar coleções {#searching-collections}

Você pode pesquisar coleções no console Coleções. Ao pesquisar com palavras-chave na caixa Omnisearch, [!DNL Assets] procura nomes de coleção, metadados e as tags adicionadas às coleções.
...
1. Selecione uma coleção e clique em **[!UICONTROL Settings]** na barra de ferramentas. Como alternativa, use a ação rápida **[!UICONTROL Settings]** da miniatura da coleção.
...
1. Para salvar as alterações, clique em **[!UICONTROL Save]**.
...
1. Na caixa de diálogo, clique em **[!UICONTROL Delete]** para confirmar a ação de exclusão.
...
1. Na caixa de diálogo **[!UICONTROL Download]**, clique em **[!UICONTROL Download]**. Se desejar baixar as representações dos ativos na coleção, selecione **[!UICONTROL Representações]**. Selecione a opção **[!UICONTROL Email]** para enviar uma notificação por email ao proprietário da coleção.
...
1. No console Coleções , selecione a coleção ou o grupo de coleções desejado e clique em **[!UICONTROL To Collection]** na barra de ferramentas.
...
1. Na caixa de diálogo, clique em **[!UICONTROL Delete]** para excluir a pesquisa salva.
...
1. Abra **[!UICONTROL Assets]** > **[!UICONTROL Coleções]**. Para executar um workflow em uma coleção específica, selecione-o.
1. Abra o painel **[!UICONTROL Linha do tempo]**. Clique em ![divisa para cima](assets/do-not-localize/chevron-up-icon.png) e clique em **[!UICONTROL Iniciar Fluxo de Trabalho]**.
...
1. Insira um título para o workflow e clique em **[!UICONTROL Start]**.
