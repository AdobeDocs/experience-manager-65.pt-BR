...
description: Discute considerações de rede ao projetar uma  [!DNL Adobe Experience Manager Assets] implantação.
contentOwner: AG
...
* Faça upload para a Internet a partir da rede corporativa e do ambiente [!DNL Experience Manager].
* Topologia do ambiente [!DNL Experience Manager].
* Defina consumidores simultâneos da interface de rede [!DNL Experience Manager].
* Workflows definidos da implantação [!DNL Experience Manager].
...
Os dispositivos cliente se conectam à rede corporativa de várias maneiras, como WiFi compartilhado, ethernet a um switch compartilhado e VPN. Identificar e entender pontos de interrupção nesta rede é importante para [!DNL Assets] planejar e modificar a rede.
...
A criação da topologia do ambiente [!DNL Experience Manager] requer um conhecimento detalhado da configuração do sistema e de como a rede é conectada dentro do ambiente do usuário.
...
O dispatcher compartilha sua conexão de 100 Mbps com duas entidades, o mundo externo e a implantação [!DNL Experience Manager]. Para operações simultâneas de upload e download, você deve dividir esse número por dois. O armazenamento externo conectado usa uma conexão separada.

A implantação [!DNL Experience Manager] compartilha sua conexão de 1Gbps com vários serviços. Do ponto de vista da topologia da rede, equivale a compartilhar um único canal com diferentes serviços.
...
## Workflows definidos da implantação [!DNL Experience Manager] {#defined-workflows-of-the-aem-deployment}
