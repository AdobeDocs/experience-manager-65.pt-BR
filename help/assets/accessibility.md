---
title: Recursos e interfaces acessíveis de [!DNL Experience Manager Assets]
description: Saiba como os recursos de acessibilidade em [!DNL Adobe Experience Manager] 6,5 [!DNL Assets] ajude usuários portadores de deficiências.
contentOwner: AG
...
[!DNL Adobe Experience Manager] O permite que criadores e editores de conteúdo vejam experiências incríveis na Web. O Adobe se esforça para incluir criadores com deficiência, melhorando a acessibilidade de [!DNL Experience Manager]. O software é aprimorado continuamente para atender às necessidades de todos os tipos de usuários e seguir os padrões mundiais que incluem indivíduos com deficiências visuais, auditivas, de mobilidade ou outras.
