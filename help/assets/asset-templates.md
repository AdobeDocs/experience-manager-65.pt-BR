...
Embora os modelos de ativos sejam [!DNL Adobe InDesign] arquivos, proficiência em [!DNL Adobe InDesign] não é uma barreira à criação de artefatos estelares. Não é necessário mapear os campos de [!DNL Adobe InDesign] modelo com os campos de produto que seriam necessários ao criar catálogos. É possível editar os modelos no modo WYSIWYG diretamente na interface da Web. No entanto, para [!DNL Adobe InDesign] para processar as alterações de edição, é necessário configurar [!DNL Experience Manager Assets] para integrar com a [!DNL Adobe InDesign Server].
...
1. Para abrir o material de apoio para edição, siga um destes procedimentos:
   ...
   * Abra o material de apoio (folheto neste caso) que você criou na etapa 7 de [Criar uma peça colateral](/help/assets/asset-templates.md#creating-a-collateral).
   * Na página Modelos, navegue até a pasta onde você criou o material de apoio e clique no [!UICONTROL Editar] ação rápida na miniatura de uma peça colateral.
   ...
   * Selecione o material e clique em **[!UICONTROL Editar]** na barra de ferramentas.
   ...
   Para usar o localizador de ativos, você pode navegar ou pesquisar imagens no [!DNL Experience Manager Assets] e substitua as imagens editáveis no modelo pelas imagens de sua escolha.

   ![chlimage_1-109](assets/chlimage_1-314.png)

   As imagens editáveis são exibidas à direita. Para que um campo seja editável no [!DNL Experience Manager Assets], o campo correspondente no modelo deve ser marcado em [!DNL InDesign]. Em outras palavras, eles devem ser marcados como editáveis em [!DNL InDesign].

   >[!NOTE]
   >
   >Verifique se [!DNL Experience Manager] A implantação é integrada com um [!DNL InDesign Server] para habilitar [!DNL Experience Manager Assets] para extrair dados do [!DNL InDesign] e disponibilizá-lo para edição. Para obter detalhes, consulte [Integrar o Experience Manager Assets com o InDesign Server](/help/assets/indesign.md).
...
1. Selecionar **[!UICONTROL Visualizar]** para que você possa visualizar as alterações de texto.

1. Para trocar uma imagem, selecione a variável **[!UICONTROL Localizador de ativos]** ![chlimage_1-113](assets/chlimage_1-318.png).
...
1. Selecionar **[!UICONTROL Visualizar]** para que você possa visualizar a imagem.
...
1. Selecionar **[!UICONTROL Visualizar]** na barra de ferramentas, para que você possa visualizar todas as alterações. Selecionar **[!UICONTROL Concluído]** para salvar as alterações de edição no material de apoio.
...
1. Selecione a representação de PDF na lista de representações para baixar o arquivo de PDF. Abra o arquivo PDF para revisar o material de apoio.

   ![chlimage_1-119](assets/chlimage_1-324.png)

## Mesclar material de apoio {#merge-collateral}

1. No [!DNL Experience Manager] , selecione [!UICONTROL Assets] na página Navegação.

1. Nas opções, selecione **[!UICONTROL Modelos]**.

1. Selecionar **[!UICONTROL Criar]**, em seguida, no menu, selecione **[!UICONTROL Mesclar]**.

   ![chlimage_1-120](assets/chlimage_1-325.png)

1. No [!UICONTROL Mesclagem de modelos] selecione **[!UICONTROL Mesclar]** ![adicionar ativos](assets/do-not-localize/assets_add_icon.png).
...
1. Selecionar **[!UICONTROL Próxima]** na barra de ferramentas.
1. No **[!UICONTROL Visualizar e reordenar]** , reorganize os modelos se necessário e visualize a seleção de modelos a serem mesclados. Na barra de ferramentas, selecione **[!UICONTROL Próxima]**.
...
1. Selecionar **[!UICONTROL Salvar]**, feche a caixa de diálogo selecionando **[!UICONTROL OK]**. O material de apoio de várias páginas é criado na pasta em que você começou.
