...
Embora os modelos de ativos sejam principalmente arquivos do Adobe InDesign, a proficiência no Adobe InDesign não é uma barreira para a criação de artefatos estelares. Não é necessário mapear os campos do modelo do Adobe InDesign com os campos do produto que você precisaria para criar catálogos. Você pode editar os modelos no modo WYSIWYG diretamente na interface da Web. No entanto, para que o Adobe InDesign processe suas alterações de edição, é necessário primeiro configurar os ativos AEM para integrar-se ao servidor do Adobe InDesign.

A capacidade de editar modelos do Adobe InDesign na interface da Web ajuda a promover maior colaboração entre a equipe da Creative e da Marketing, além de reduzir o tempo de comercialização para iniciativas promocionais locais.
...
1. Clique ou toque no logotipo do AEM e clique/toque em Ativos.
...
1. (Opcional) Toque em **[!UICONTROL Tags]** e selecione uma ou mais tags para o folheto. Toque em **[!UICONTROL Confirmar]** para confirmar sua seleção.
...
1. Para abrir o material promocional para edição, execute um dos procedimentos a seguir:
   ...
   * Na página de ativos do material de apoio, toque em **[!UICONTROL Editar]** na barra de ferramentas.
   * Selecione o material de apoio e toque em **[!UICONTROL Editar]** na barra de ferramentas.
   ...
   >[!NOTE]
   >
   >Certifique-se de que sua instância do AEM esteja integrada a um servidor do InDesign para permitir que os ativos AEM extraiam dados do modelo do InDesign e os disponibilizem para edição. Para obter detalhes, consulte [Integração de ativos AEM com o InDesign Server](/help/assets/indesign.md).
...
1. Toque em **[!UICONTROL Visualizar]** para visualizar as alterações de texto.

   ![chlimage_1-112](assets/chlimage_1-317.png)

1. Para trocar uma imagem, toque no Localizador **[!UICONTROL de ativos]**.
...
1. Toque em **[!UICONTROL Visualizar]** para visualizar a imagem.
...
1. Toque em **[!UICONTROL Visualizar]** na barra de ferramentas para visualizar todas as alterações. Clique/toque em **[!UICONTROL Concluído]** para salvar as alterações de edição no material de apoio.
...
1. Clique ou toque no logotipo do AEM e, em seguida, clique/toque em Ativos na página Navegação.
1. Nas opções, escolha **[!UICONTROL Modelos]**.
1. Clique/toque em **[!UICONTROL Criar]** e escolha **[!UICONTROL Mesclar]** no menu.

   ![chlimage_1-120](assets/chlimage_1-325.png)

1. Na página [!UICONTROL Mesclagem] de modelo, toque em **[!UICONTROL Mesclar]**.
...
1. Navegue até o local do material de apoio que deseja mesclar, clique/toque nas miniaturas do material de apoio que deseja mesclar para selecioná-las.
   ...
   Você também pode procurar modelos na caixa Omnisearch.
...
1. Na tela Configurar modelo, especifique um nome para o material de apoio. Opcionalmente, especifique quaisquer tags que você considerar apropriadas. Se desejar exportar a saída no formato PDF, selecione a opção **Acrobat (.PDF)** . Por padrão, o material de apoio é exportado nos formatos JPG e InDesign. Para alterar a miniatura de exibição do material de suporte de várias páginas, clique/toque em **[!UICONTROL Alterar miniatura]**.

   ![chlimage_1-127](assets/chlimage_1-332.png)

1. Clique/toque em **[!UICONTROL Salvar]** e, em seguida, clique/toque em **[!UICONTROL OK]** na caixa de diálogo para fechar a caixa de diálogo. O material de apoio de várias páginas é criado na pasta com a qual você começou.
