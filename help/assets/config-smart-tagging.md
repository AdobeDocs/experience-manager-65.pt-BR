...
1. Na interface do usuário do AEM, toque no logotipo do AEM e vá para **[!UICONTROL Ferramentas > Serviços]** em nuvem > Serviços **[!UICONTROL em nuvem]** herdados.

1. Na página Serviços em nuvem, toque/clique em **[!UICONTROL Configurar agora]** em Tags inteligentes **[!UICONTROL de ativos]**.
...
Quando o certificado expira, não é mais confiável. Para adicionar um novo certificado, siga estas etapas. Não é possível renovar um certificado expirado.
...
1. Exclua o armazenamento de chave **[!UICONTROL similaritysearch]** existente com o certificado expirado. Clique em **[!UICONTROL Salvar e fechar]**.
...
1. Navegue até **[!UICONTROL Ferramentas]** > Serviços **[!UICONTROL da]** Cloud > Serviços **[!UICONTROL da]** Legacy Cloud. Clique em Tags **[!UICONTROL inteligentes de]** ativos > **[!UICONTROL Mostrar configuração]** > Configurações **** disponíveis. Clique na configuração necessária.
...
1. Na página **[!UICONTROL Integrações]** , selecione a conta apropriada e verifique se a função de organização associada é administrador do sistema.
1. Toque em **[!UICONTROL Nova integração]**.
1. Na página **[!UICONTROL Criar uma nova integração]** , selecione **[!UICONTROL Acessar uma API]**. Toque em **[!UICONTROL Continuar]**.
1. Em **[!UICONTROL Experience Cloud]**, selecione Conteúdo **** inteligente. Toque em **[!UICONTROL Continuar]**.
...
1. Na caixa de diálogo Serviço **[!UICONTROL de conteúdo inteligente do]** AEM, use os valores pré-preenchidos para os campos URL **[!UICONTROL do]** serviço e Servidor **[!UICONTROL de]** autorização.
1. Para os campos Chave **[!UICONTROL da]** API, Id **[!UICONTROL da conta]** técnica, Id **[!UICONTROL da]** organização e Segredo **[!UICONTROL do]** cliente, use os valores gerados acima.
...
1. Na página Modelos **[!UICONTROL de]** fluxo de trabalho, selecione o modelo de fluxo de trabalho Atualizar ativo **[!UICONTROL do]** DAM.
1. Toque/clique em **[!UICONTROL Editar]** na barra de ferramentas.
1. Expanda o painel lateral para exibir as etapas. Arraste a etapa Ativo **[!UICONTROL de tag]** inteligente que está disponível na seção Fluxo de trabalho do DAM e coloque-a após a etapa **[!UICONTROL Processar miniaturas]** .
...
1. Abra a etapa no modo de edição. Em Configurações **** avançadas, verifique se a opção **[!UICONTROL Handler Advance]** está selecionada.
...
1. Toque em **[!UICONTROL OK]** para fechar a etapa do processo e, em seguida, salve o fluxo de trabalho.
