...
Você pode fazer a integração [!DNL Adobe Experience Manager] com o Serviço de conteúdo inteligente usando a E/S da Adobe. Use essa configuração para acessar o Serviço de conteúdo inteligente de dentro [!DNL Experience Manager].
...
1. Na interface do [!DNL Experience Manager] usuário, acesse **[!UICONTROL Ferramentas > Serviços]** em nuvem > Serviços **[!UICONTROL da]** Legacy Cloud.
...
1. Expanda o painel lateral para exibir as etapas. Arraste a etapa **[!UICONTROL Ativo de tag inteligente]** disponível na seção Fluxo de trabalho do DAM e coloque-a após a etapa **[!UICONTROL Processar miniaturas]**.
   ...
   *Figura: Adicione a etapa de ativo de tag inteligente após a etapa de miniatura do processo no fluxo de trabalho de Atualização de ativo[!UICONTROL do]DAM.*
