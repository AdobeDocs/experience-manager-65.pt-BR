...
1. Siga um destes procedimentos para abrir **[!UICONTROL Editor de imagem no local]**:
   ...
   * Usando Ações rápidas, clique em **[!UICONTROL Editar]** que aparece em um ativo no **[!UICONTROL Cartão]** exibir. Na exibição Lista, selecione o ativo e clique em **[!UICONTROL Editar]** na barra de ferramentas.
...
1. Para inserir um mapa de imagem, clique em **[!UICONTROL Mapa de lançamento]** ![mapa de imagens](assets/do-not-localize/image-map-icon.png) na barra de ferramentas.
...
1. Clique em **[!UICONTROL Confirmar]** e, em seguida, clique em **[!UICONTROL Concluir]** ![selecionar verificação concluída](assets/do-not-localize/check-ok-done-icon.png) na barra de ferramentas para salvar as alterações.
