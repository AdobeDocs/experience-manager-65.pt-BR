...
Para fazer a associação, primeiro é necessário [adicionar o(s) ativo(s) de mídia a uma coleção](/help/assets/manage-collections.md). Depois disso, você pode:
...
1. Confirme (com **Select**). A coleção será listada como associada.
