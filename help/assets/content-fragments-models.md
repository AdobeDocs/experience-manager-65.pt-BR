...
Modelos de fragmento de conteúdo definem a estrutura do conteúdo para seus fragmentos [de](/help/assets/content-fragments.md)conteúdo.
...
Para usar outras configurações (ou seja, excluindo globais) com uma pasta Assets comparável, é necessário definir a conexão. Isso é feito usando **Configuração** na guia Serviços **da** nuvem das Propriedades **da** pasta da pasta apropriada.
