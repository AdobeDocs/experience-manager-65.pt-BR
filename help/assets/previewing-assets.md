...
>[!NOTE]
>
>Quando você está em uma página da Web (Sites) no AEM, não pode visualizar ativos no modo **Editar**. Você precisa acessar o modo **Visualização** clicando em **Visualização** no canto superior direito.
...
**Para pré-visualização de ativos usando a interface do usuário**
