...
>[!NOTE]
>
>Durante a execução no modo Mídia dinâmica - Scene7, observe que a publicação imediata não é publicada automaticamente no YouTube. When Dynamic Media - Scene7 mode is set up, there are two publish options to choose from: **[!UICONTROL Immediately]** or **[!UICONTROL Upon Activation]**.
>
