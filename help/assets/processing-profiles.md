...
1. Na caixa de diálogo Carregamento em **[!UICONTROL lote para o Scene7—Step Properties]** , defina o seguinte:
   * Nos campos de texto **[!UICONTROL Título]** e **[!UICONTROL Descrição]** , insira um novo título e descrição para o job, se desejado.
   ...
   * No campo **** Lote, informe o número máximo de ativos (50-1000) a serem processados em um trabalho de upload de processamento em lote do servidor do Dynamic Media.
