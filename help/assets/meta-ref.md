...
Os metadados do Dublin Core fornecem um conjunto padronizado de convenções para descrever ativos para facilitar sua localização. No Assets, o Dublin Core descreve os ativos digitais, incluindo vídeo, som, imagens e documentos.
...
| format | O formato de arquivo, a mídia física ou as dimensões do ativo. O Experience Manager usa `dc:format` para indicar o tipo MIME do ativo. |
