---
title: Pastas do Publish para o Brand Portal
...
## Pastas do Publish para o Brand Portal {#publish-folders-to-brand-portal-1}
...
1. **Publicar pastas agora**
   ...
   * Na barra de ferramentas, selecione **Gerenciar publicação**.
   ...
   1. Em **Ação**, selecione **Publish para Brand Portal**, em **Agendamento**, selecione **Agora** e clique em **Avançar.**
   ...
   **Publicar pastas mais tarde**
   ...
   1. Em **Ação**, selecione **Publish para Brand Portal**, em **Agendamento**, selecione **Depois**.
