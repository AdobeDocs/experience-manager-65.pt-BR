...
É difícil estimar com precisão o tamanho do arquivo TIFF compatível out-of-the-box com um heap específico para o AEM, pois fatores adicionais, como o tamanho dos pixels, influenciam o processamento. É possível que o AEM possa processar um arquivo de 255 MB pronto para uso, mas não possa processar um tamanho de arquivo de 18 MB, pois este último é composto por um número invulgarmente maior de pixels em comparação ao primeiro.
