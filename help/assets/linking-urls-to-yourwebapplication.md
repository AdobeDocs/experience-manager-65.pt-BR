...
Consulte também [Carregando ativos.](manage-assets.md#uploading-assets)
...
1. Selecione e copie o texto no navegador da Web para pré-visualização do ativo ou para adicionar à página de conteúdo da Web.
   ...
   Para sair da janela do URL, toque em **[!UICONTROL X]** ou toque em **[!UICONTROL Fechar.]**
...
1. No AEM, navegue até **[!UICONTROL Ferramentas > Implantação > Nuvem > Cloud Services.]**
