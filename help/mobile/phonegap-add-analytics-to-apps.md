...
O AEM Mobile requer uma conta do Adobe Analytics para coletar e relatar dados de rastreamento no aplicativo. Como parte da configuração, o *administrador* do AEM precisa primeiro:
