...
Esse diretório contém o [Ganchos da CLI](https://gist.github.com/jlcarvalho/22402d013bc72f795d45a01836ce735c). As pastas no diretório hooks contêm scripts node.js que são executados em pontos exatos durante a criação.
