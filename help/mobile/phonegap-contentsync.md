---
title: Sincronização de conteúdo para Adobe PhoneGap Enterprise com AEM
description: Siga esta página para saber mais sobre a Sincronização de conteúdo para o Adobe PhoneGap Enterprise com AEM.
...
>[!NOTE]
>
>Os aplicativos PhoneGap criados com as ferramentas do AEM já estão configurados para usar páginas AEM como conteúdo por meio da Sincronização de conteúdo.
...
**conteúdo** Renderize o conteúdo usando o processamento padrão de solicitação do Sling.
