...
description: Com o Adobe Mobile Services, você pode obter o insight sobre como seus usuários estão usando seus aplicativos móveis rastreando o uso, falhas do aplicativo, detalhes do dispositivo e muitas outras métricas críticas para seus aplicativos móveis. Siga esta página para saber mais.
contentOwner: User
...
Esta seção descreve como [os desenvolvedores do AEM](#developers) podem aprender a equipar os aplicativos AEM Mobile com o rastreamento de análise.

Finalmente, [Administradores do AEM](#administrators) aprendem a:
...
**Pré-requisito:** os administradores do AEM devem configurar a configuração de nuvem do Adobe Mobile Services, [conforme discutido abaixo](#amscloudserviceconfig).
...
## Para administradores - Configurar o Adobe Mobile Services Cloud Service {#for-administrators-configure-the-adobe-mobile-services-cloud-service}

Para aproveitar os serviços do Adobe Mobile Services, você deve configurar o AEM Adobe Mobile Services Cloud Service com as informações de sua conta do Adobe Analytics. O Centro de Comando de Aplicativos fornece um bloco **Analisar Métricas**, no qual você pode criar e associar o serviço de nuvem ao seu aplicativo móvel.
...
Para começar, clique no botão &quot;+&quot; no bloco Gerenciar serviços em nuvem no painel.
...
Selecione ou crie uma configuração de serviço para dispositivos móveis preenchendo os campos obrigatórios conforme mostrado abaixo. O administrador do AEM exige essas informações para criar com êxito a conexão com o Adobe Mobile Services.
...
A primeira etapa é obter a configuração do SDK no Adobe Mobile Services. Clique em &quot;Baixar a configuração do AMS SDK&quot; para ser redirecionado para o site do Adobe Mobile Services em que você pode baixar o arquivo de configuração. Depois de obter o arquivo ADBMobileConfig.json, clique em &quot;Fazer upload da configuração do AMS SDK&quot; para fazer upload do arquivo de configuração no AEM.

![chlimage_1-131](assets/chlimage_1-131.png)

Clique no botão &quot;Fazer upload da configuração do aplicativo do Adobe Mobile Services&quot;, procure o arquivo ADBMobileConfig.json e clique em &quot;Fazer upload&quot;.
