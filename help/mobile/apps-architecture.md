...
A documentação do PhoneGap (`https://docs.phonegap.com`) refere-se a esse arquivo como um &quot;arquivo de configuração global&quot;. O config.xml contém muitas propriedades do aplicativo, como o nome do aplicativo, as &quot;preferências&quot; do aplicativo (por exemplo, se uma visualização da Web do iOS permite ou não rolagem excessiva) e as dependências de plug-in que são *somente* consumido pelo PhoneGap build.
