...
* Está incluído um Rastreador de aplicativo que verifica a compatibilidade do dispositivo, analisa registros, percorre visualizações, captura de tela e monitora o desempenho.
