...
| [Linguagem de modelo do HTML](https://experienceleague.adobe.com/br/docs/experience-manager-htl/content/overview) | Todos os componentes são baseados em HTL |  |
