...
* Todo o conteúdo é armazenado no `jcr:content/data` nó do ativo:
   ...
   * As variações são armazenadas em um subnó que contém o nome da variação:por exemplo `jcr:content/data/myvariation`
...
* **Tipos** de recursos É `sling:resourceTypes` possível fornecer uma lista de componentes que são usados para renderizar fragmentos de conteúdo e para os quais o processamento em segundo plano deve ser aplicado.
