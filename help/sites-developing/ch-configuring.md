...
Para salvar dados do serviço MD5 do site jsontest.com, use o procedimento em [Criação de uma loja do ContextHub](/help/sites-developing/ch-configuring.md#creating-a-contexthub-store) usando as seguintes propriedades:
...
Use o procedimento em [Adicionar um módulo de interface](#adding-a-ui-module) para adicionar o módulo de interface a um modo de interface de usuário existente, como o exemplo de Modo de interface de usuário Perona. Para o Módulo de interface, use os seguintes valores de propriedade:
