...
1. Carregue o aplicativo de Journal We.Retail no servidor de publicação ou usando a opção **Visualização como Publicado** do menu **Informações da página** no editor de páginas.
