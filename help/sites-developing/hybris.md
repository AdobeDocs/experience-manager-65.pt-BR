...
>[!NOTE]
>
>A estrutura de comércio eletrônico pode ser usada com qualquer solução de comércio eletrônico. Determinados detalhes e exemplos tratados aqui se referem à solução [SAP Commerce Cloud](https://www.hybris.com/) .
...
* A `cq:commerceProvider` propriedade é também utilizada para fazer referência à definição de fábrica de comércio adequada.
   ...
   * Aqui, outras propriedades, como a versão [****do catálogo, podem ser configuradas](#configuringthecatalogversion)(quando apropriado e disponível).
...
* AuthenticationO AEM é considerado o *único* front-end da Web e, portanto, realiza *toda* a autenticação.

* Contas escravasO AEM cria uma conta escrava em híbridos para cada comprador. O nome de usuário da conta escrava é igual ao nome de usuário do AEM. Uma senha criptograficamente aleatória é gerada automaticamente e armazenada (criptografada) no AEM.
