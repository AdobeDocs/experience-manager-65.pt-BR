...
+ Práticas recomendadas    {#bestpractices}
   ...
   + [Diretrizes de desenvolvimento do AEM e práticas recomendadas](https://experienceleague.adobe.com/docs/experience-manager-65/developing/introduction/dev-guidelines-bestpractices.html)
