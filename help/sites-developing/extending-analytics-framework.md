...
Há várias variáveis predefinidas no Adobe Analytics que podem ser configuradas em uma estrutura. O **charset**, **cookieLifetime**, **currencyCode** e **trackInlineStats** são incluídas na variável **Configurações gerais do Analytics** por padrão.
