...
Para usar componentes direcionados em suas páginas que interagem com o Adobe Target, inclua o código específico do cliente no elemento &lt;head>.
...
>[!NOTE]
>
>Somente a versão de `at.js` entregue com o produto é suportada. A versão do `at.js` enviado com o produto pode ser obtida consultando o `at.js` arquivo no local:
>
...
1. Vá para a página **Ferramentas** do CQ e selecione Serviços **** em nuvem. ([https://localhost:4502/libs/cq/core/content/tools/cloudservices.html](https://localhost:4502/libs/cq/core/content/tools/cloudservices.html))
...
A configuração do Target inclui um arquivo mbox.js personalizado, [o código necessário na seção](/help/sites-developing/target.md#p-the-head-section-p) de cabeçalho da página adiciona o arquivo à estrutura da biblioteca do cliente em vez de uma referência à biblioteca testandtarget.js.
