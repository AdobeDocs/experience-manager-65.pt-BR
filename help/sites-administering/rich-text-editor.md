...
>* Sobre como descontinuar a interface clássica, consulte as [notas de versão do Experience Manager 6.5](/help/release-notes/deprecated-removed-features.md)
>* Para saber a diferença entre as interfaces, consulte [Interface para toque e Interface Clássica](https://aemcq5pedia.wordpress.com/2018/01/05/touch-enabled-ui-aem6-3/)
>* Para entender a interface habilitada para toque detalhadamente, consulte [Conceitos da interface de toque do Experience Manager](/help/sites-developing/touch-ui-concepts.md)
...
>* [Usar Rich Text Editor para criação](../sites-authoring/rich-text-editor.md)
...
>* [Amostra de tutorial para criar componente multicampo composto](https://experience-aem.blogspot.com/2019/05/aem-65-touchui-composite-multifield-with-coral3-rte-rich-text.html?lang=pt-BR)
