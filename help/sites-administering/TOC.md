...
+ Segurança {#security}
   ...
   + [Exibição principal para gerenciamento de permissões](touch-ui-principal-view.md)
   ...
   + [Suporte a cookie Same Site](same-site-cookie-support.md)
...
+ Práticas recomendadas     {#bestpractices}
   ...
   + [Lidar com solicitações do GDPR para a Fundação AEM](https://experienceleague.adobe.com/docs/experience-manager-65/administering/security/handling-gdpr-requests-for-aem-platform.html)
