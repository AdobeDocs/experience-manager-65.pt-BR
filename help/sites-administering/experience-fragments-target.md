...
Você pode exportar Fragmentos [de](/help/sites-authoring/experience-fragments.md)experiência criados no Adobe Experience Manager (AEM) para o Adobe Target. Eles podem ser usados como ofertas em atividades do Target, para testar e personalizar experiências em escala.
...
* JSON: Suporte para entrega de conteúdo sem cabeçalho
* HTML e JSON

Os Fragmentos de experiência do AEM podem ser exportados para a área de trabalho padrão no Adobe Target ou para espaços de trabalho definidos pelo usuário para o Adobe Target. Isso é feito via E/S da Adobe, para a qual o AEM deve ser [integrado ao Adobe Target usando E/S](/help/sites-administering/integration-ims-adobe-io.md)da Adobe.

>[!NOTE]
>
>Os espaços de trabalho do Adobe Target não existem no próprio Adobe Target. Eles são definidos e gerenciados no Adobe IMS (Identity Management System) e, em seguida, selecionados para uso em soluções que usam integrações de E/S da Adobe.

>[!NOTE]
>
>Os espaços de trabalho do Adobe Target podem ser usados para permitir que membros de uma organização (grupo) criem e gerenciem ofertas e atividades somente para essa organização; sem dar acesso a outros usuários. Por exemplo, organizações específicas a cada país dentro de uma preocupação global.
...
Antes de exportar um fragmento, é necessário adicionar a Configuração **da** nuvem para o **Adobe Target** ao fragmento ou pasta. Isso também permite:
...
1. Toque/clique em **OK** na caixa de diálogo de confirmação.
   ...
   >[!NOTE]
   >
   >[Vários detalhes](/help/sites-authoring/experience-fragments.md#details-of-your-experience-fragment) da exportação podem ser vistos na **Exibição** de lista do console e **Propriedades**.

   >[!NOTE]
   >
   >Ao exibir um fragmento de experiência no Adobe Target, a *última data modificada* que é vista é a data em que o fragmento foi modificado pela última vez no AEM, não a data em que o fragmento foi exportado pela última vez para o Adobe Target.
