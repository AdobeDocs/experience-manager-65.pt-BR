...
Para obter informações adicionais sobre o número máximo de ativos que podem ser operados com AEM 6.5, consulte [Guia de dimensionamento de ativos](/help/assets/assets-sizing-guide.md).
...
Para configurar e configurar o Asset Insights para o Experience Manager implantado via Adobe Ativação (DTM), consulte como [Configurar o Asset Insights com o AEM Assets](https://docs.adobe.com/content/help/en/experience-manager-learn/assets/advanced/asset-insights-launch-tutorial.html).
...
Para saber mais detalhadamente, consulte [Guia de Migração do CoralUI 3 baseado em](https://helpx.adobe.com/experience-manager/6-5/sites/developing/using/reference-materials/granite-ui/api/jcr_root/libs/granite/ui/components/legacy/coral2/migration.html).
...
Consulte [Aspectos de pesquisa](/help/assets/search-facets.md) para saber mais.
