...
Se a resposta contiver a linha `a4tEnabled:false`, entre em contato com o [Atendimento ao cliente do Adobe](https://helpx.adobe.com/contact.html) para obter a configuração correta da sua conta.
