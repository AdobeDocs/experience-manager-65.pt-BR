...
## Configuração da replicação para a instância de publicação do AEM {#replication}
...
Você configurou o Externalizador e o Adobe Campaign não pode acessar o conteúdo.
