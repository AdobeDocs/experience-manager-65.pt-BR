...
A Adobe está animada em anunciar a disponibilidade da entrega de conteúdo HTTP/2. Quando você usa HTTP/2, um desempenho geral aumentado é percebido.
...
1. [Use o Admin Console para criar um caso de suporte](https://helpx.adobe.com/br/enterprise/admin-guide.html/enterprise/using/support-for-experience-cloud.ug.html) e solicitar a mudança para HTTP/2; isso não é feito automaticamente para você.
