...
1. Toque no ícone do AEM e navegue até **[!UICONTROL Ferramentas > Operações > Console]** da Web.
...
* Verifique se o ativo que você está tentando carregar está na pasta de destino **[!UICONTROL do]** CQ (você especifica essa pasta na configuração de nuvem do Dynamic Media Classic).
